...
class AddAprovacaoExtraToFeriasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('ferias', function (Blueprint $table) {
            $table->unsignedBigInteger('aprovacao_extra_id')->nullable()->after('gestor_aprovacao_id');
            ...
            $table->dateTime('data_aprovacao_extra')->nullable()->after('obs_aprovacao_extra');
