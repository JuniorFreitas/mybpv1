...
class AddForeignKeysToDemissaoPrevistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('demissao_previstas', function (Blueprint $table) {
            $table->dropForeign('demissao_previstas_centro_custo_id_foreign');
            $table->dropForeign('demissao_previstas_cliente_id_foreign');
            $table->dropForeign('demissao_previstas_colaborador_id_foreign');
            $table->dropForeign('demissao_previstas_user_id_foreign');
        });
    }
}
