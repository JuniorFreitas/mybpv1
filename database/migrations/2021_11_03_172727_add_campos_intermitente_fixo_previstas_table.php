...
class AddCamposIntermitenteFixoPrevistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('intermitente_fixo_previstas', function (Blueprint $table) {
            ...
            $table->date('data_modificacao')->nullable()->after('user_id');
            $table->renameColumn('obs','motivos');
        });
    }
