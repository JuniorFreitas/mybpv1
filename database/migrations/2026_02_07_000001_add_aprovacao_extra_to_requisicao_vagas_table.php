...
class AddAprovacaoExtraToRequisicaoVagasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('requisicao_vagas', function (Blueprint $table) {
            $table->unsignedBigInteger('aprovacao_extra_id')->nullable()->after('status_aprovacao');
            ...
            $table->foreign('aprovacao_extra_id')->references('id')->on('users');
        });
    }
