...
class AddForeignKeysToAdmissoesPrevistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('admissoes_previstas', function (Blueprint $table) {
            $table->dropForeign('admissoes_previstas_cargo_id_foreign');
            $table->dropForeign('admissoes_previstas_centro_custo_id_foreign');
            $table->dropForeign('admissoes_previstas_cliente_id_foreign');
            $table->dropForeign('admissoes_previstas_colaborador_id_foreign');
            $table->dropForeign('admissoes_previstas_user_id_foreign');
        });
    }
}
