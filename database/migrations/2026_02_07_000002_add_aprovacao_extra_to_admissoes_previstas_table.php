...
class AddAprovacaoExtraToAdmissoesPrevistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('admissoes_previstas', function (Blueprint $table) {
            ...
            $table->enum('status_aprovacao_extra', ['aprovado', 'reprovado'])->nullable()->after('aprovacao_extra_id');
