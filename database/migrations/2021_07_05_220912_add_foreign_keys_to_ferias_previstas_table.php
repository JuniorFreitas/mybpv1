...
class AddForeignKeysToFeriasPrevistasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('ferias_previstas', function (Blueprint $table) {
            $table->dropForeign('ferias_previstas_centro_custo_id_foreign');
            $table->dropForeign('ferias_previstas_cliente_id_foreign');
            $table->dropForeign('ferias_previstas_colaborador_id_foreign');
            $table->dropForeign('ferias_previstas_user_id_foreign');
        });
    }
}
