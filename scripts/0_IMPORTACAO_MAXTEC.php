...
\Excel::import($import, base_path('scripts/xls/27.08.2024_importacao_maxtec.xlsx'));
...
//    echo "Linha: " . $count . " CNPJ: {$line['cnpj']} - NOME: {$line['nome']}" . PHP_EOL;
    echo "Linha: " . $count . " NOME: {$line['nome']}" . PHP_EOL;
...
$outputFile = base_path("scripts/xls/logs_import/" . (new \MasterTag\DataHora())->dataInsert() . '_importacao_maxtec_log.txt');
