...
const app = createApp({
    ...
    methods: {
        ...
        formAlterar(curriculo_id) {
            ...
            axios
                .get(`${URL_ADMIN}/certificado/${curriculo_id}/editar`)
                .then((response) => {
                    let data = response.data
                    ...
                    this.form.certificado.empresa_treinamento_trinta_tres_id = data.certificado.empresa_treinamento_trinta_tres_id
                        ? data.certificado.empresa_treinamento_trinta_tres_id
                        : ''
                    this.form.certificado.empresa_treinamento_trinta_cinco_id = data.certificado.empresa_treinamento_trinta_cinco_id
                        ? data.certificado.empresa_treinamento_trinta_cinco_id
                        : ''
                    ...
                    this.form.certificado.instrutor_trinta_cinco_id = data.certificado.instrutor_trinta_cinco_id
                        ? data.certificado.instrutor_trinta_cinco_id
                        : ''
        ...
        salvar() {
            ...
            axios
                .post(`${URL_ADMIN}/certificado`, this.form)
                .then((response) => {
