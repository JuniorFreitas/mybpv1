...
const app = createApp({
    ...
    methods: {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/clouds/configuracoes`, this.form)
                .then((response) => {
        ...
        formAlterar(id) {
            ...
            formReset()
            axios
                .get(`${URL_ADMIN}/clouds/configuracoes/${id}/editar`)
                .then((response) => {
                    this.editando = true
                    let data = response.data
        ...
        alterar() {
            ...
            axios
                .put(`${URL_ADMIN}/clouds/configuracoes/${this.form.id}`, this.form)
                .then((response) => {
                    let data = response.data
                    this.preloadAjax = false
        ...
        apagar() {
            ...
            axios
                .delete(`${URL_ADMIN}/clouds/configuracoes/${this.form.id}`, this.form)
                .then((response) => {
                    let data = response.data
                    this.preloadAjax = false
                    this.apagado = true
