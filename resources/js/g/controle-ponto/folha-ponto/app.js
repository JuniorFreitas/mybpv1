...
const app = createApp({
    ...
    computed: {
        ...
        totalHorasNormais() {
            let total = 0
            this.formPonto.pontos
                .filter((ponto) => ponto.periodos_em_aberto.length === 0)
                .forEach((ponto) => {
    ...
    methods: {
        ...
        verDetalhes(id) {
            ...
            this.USER_ID = id
            axios
                .get(`${URL_ADMIN}/controle-ponto/folha-ponto/${id}/editar`)
                .then((response) => {
        ...
        buscarFrequencia() {
            ...
            axios
                .post(`${URL_ADMIN}/controle-ponto/folha-ponto/${this.USER_ID}/frequencia`, { intervalo: this.formPonto.intervalo })
                .then(({ data }) => {
