...
const app = createApp({
    ...
    methods: {
        ...
        cadastrar: function () {
            ...
            axios
                .post(`${URL_ADMIN}/controle-ponto/ocorrencias_jornadas/`, dados)
                .then((response) => {
        ...
        formAlterar: function (id) {
            ...
            axios
                .get(`${URL_ADMIN}/controle-ponto/ocorrencias_jornadas/${id}/editar`)
                .then((response) => {
        ...
        alterar: function () {
            ...
            axios
                .put(`${URL_ADMIN}/controle-ponto/ocorrencias_jornadas/${this.id}`, dados)
                .then((data) => {
                    this.preloadAjax = false
        ...
        apagar: function () {
            ...
            axios
                .delete(`${URL_ADMIN}/controle-ponto/ocorrencias_jornadas/${this.id}`, null)
                .then((data) => {
                    this.preloadAjax = false
                    this.apagado = true
                    this.atualizar()
