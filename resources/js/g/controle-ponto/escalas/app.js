...
const app = createApp({
    ...
    methods: {
        getPermissoes() {
            this.preload = true
            axios
                .get(`${URL_ADMIN}/controle-ponto/escalas/getPermissoes/`)
                .then((response) => {
                    this.preload = false
        ...
        formEditarEscala(escala) {
            ...
            axios
                .get(`${URL_ADMIN}/controle-ponto/escalas/${escala.id}/editar`)
                .then((response) => {
        ...
        salvarEscala() {
            ...
            if (this.formEscala.editando) {
                axios
                    .put(`${URL_ADMIN}/controle-ponto/escalas/${this.formEscala.id}`, this.formEscala)
                    .then((response) => {
                        this.formEscala.preload = false
                ...
                axios
                    .post(`${URL_ADMIN}/controle-ponto/escalas`, this.formEscala)
                    .then((response) => {
                        this.formEscala.preload = false
                        this.formEscala.save = true
                        this.atualizarListaEscalas()
        ...
        apagarEscala: function () {
            ...
            axios
                .delete(`${URL_ADMIN}/controle-ponto/escalas/${this.formEscala.id}`, null)
                .then((data) => {
                    this.formEscala.preload = false
                    this.formEscala.save = true
                    this.atualizarListaEscalas()
        ...
        selecionarEscala(escala) {
            ...
            this.formEscalaFuncionarios.escalasSelecionadas.length === 0
        ...
        assosicarEscala() {
            this.formEscalaFuncionarios.preload = true
            axios
                .put(`${URL_ADMIN}/controle-ponto/escalas/assosicarEscalas`, this.formEscalaFuncionarios)
                .then((response) => {
                    this.formEscalaFuncionarios.preload = false
