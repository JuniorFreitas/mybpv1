...
const app = createApp({
    ...
    methods: {
        ...
        cadastrar: function () {
            ...
            axios
                .post(`${URL_ADMIN}/formas-pagamento/`, dados)
                .then((response) => {
        ...
        formAlterar: function (id) {
            ...
            axios
                .get(`${URL_ADMIN}/formas-pagamento/${id}/editar`)
                .then((response) => {
        ...
        alterar: function () {
            ...
            axios
                .put(`${URL_ADMIN}/formas-pagamento/${this.id}`, dados)
                .then((data) => {
                    this.preloadAjax = false
        ...
        apagar: function () {
            ...
            axios
                .delete(`${URL_ADMIN}/formas-pagamento/${this.id}`, null)
                .then((data) => {
                    this.preloadAjax = false
                    this.apagado = true
                    this.atualizar()
