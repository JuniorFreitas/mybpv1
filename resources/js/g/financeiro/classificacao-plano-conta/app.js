...
const app = new Vue({
    ...
    methods: {
        ...
        cadastrar: function () {
            ...
            axios.post(`${URL_ADMIN}/classificacao-plano-conta/`, dados)
                .then(response => {
        ...
        formAlterar: function (id) {
            ...
            axios.get(`${URL_ADMIN}/classificacao-plano-conta/${id}/editar`)
                .then((response) => {
        ...
        alterar: function () {
            ...
            axios.put(`${URL_ADMIN}/classificacao-plano-conta/${this.id}`, dados)
                .then((data) => {
                    this.preloadAjax = false;
        ...
        apagar: function () {
            ...
            axios.delete(`${URL_ADMIN}/classificacao-plano-conta/${this.id}`, null)
                .then((data) => {
                    this.preloadAjax = false;
                    this.apagado = true;
                    this.atualizar();
