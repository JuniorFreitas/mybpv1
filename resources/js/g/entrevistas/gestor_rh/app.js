...
const app = createApp({
    ...
    methods: {
        ...
        formEntrevistar(id) {
            ...
            formReset()
            axios
                .get(`${URL_ADMIN}/entrevistas/entrevista-gestor/${id}/editar`)
                .then((response) => {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/entrevistas/entrevista-gestor/`, this.form)
                .then((response) => {
                    let data = response.data
        ...
        alterar() {
            ...
            axios
                .put(`${URL_ADMIN}/entrevistas/entrevista-gestor/${this.form.parecer_rh.gestor_rh.id}`, this.form.parecer_rh.gestor_rh)
                .then((response) => {
                    let data = response.data
                    mostraSucesso('', 'Entrevista salva com sucesso!')
                    fecharModal('#janelaParecerEntrevista')
