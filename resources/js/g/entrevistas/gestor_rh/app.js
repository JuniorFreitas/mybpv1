...
const app = new Vue({
    ...
    data: {
        tituloJanela: 'Parecer Entrevista Gestor',
        preload: false,
        editando: false,
        apagado: false,
        cadastrado: false,
    ...
    computed: {
        ...
        comEntrevista() {
            return this.lista.filter(item => {
                return item.parecer_rh.gestor_rh;
            });
        },
        tudoMarcado() {
    ...
    methods: {
        ...
        formEntrevistar(id) {
            ...
            formReset();
            axios.get(`${URL_ADMIN}/entrevistas/entrevista-gestor/${id}/editar`)
                .then(response => {
        ...
        cadastrar() {
            ...
            axios.post(`${URL_ADMIN}/entrevistas/entrevista-gestor/`, this.form)
                .then(response => {
                    let data = response.data;
        ...
        alterar() {
            ...
            axios.put(`${URL_ADMIN}/entrevistas/entrevista-gestor/${this.form.parecer_rh.gestor_rh.id}`, this.form.parecer_rh.gestor_rh)
                .then(response => {
                    let data = response.data;
                    mostraSucesso('', 'Entrevista salva com sucesso!');
                    $('#janelaParecerEntrevista').modal('hide');
