...
const app = new Vue({
    ...
    methods: {
        ...
        formEntrevistar(id) {
            ...
            formReset();
            axios.get(`${URL_ADMIN}/entrevistas/parecer-teste-pratico/${id}/editar`)
                .then(response => {
        ...
        cadastrar() {
            ...
            axios.post(`${URL_ADMIN}/entrevistas/parecer-teste-pratico/`, this.form.parecer_teste)
                .then(response => {
                    let data = response.data;
        ...
        alterar() {
            ...
            axios.put(`${URL_ADMIN}/entrevistas/parecer-teste-pratico/${this.form.parecer_teste.id}`, this.form.parecer_teste)
                .then(response => {
                    let data = response.data;
                    mostraSucesso('', 'Entrevista salva com sucesso!');
                    $('#janelaParecerEntrevista').modal('hide');
