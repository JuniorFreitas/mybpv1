...
const app = createApp({
    ...
    methods: {
        ...
        formEntrevistar(id) {
            ...
            formReset()
            axios
                .get(`${URL_ADMIN}/entrevistas/parecer-entrevista-tecnica/${id}/editar`)
                .then((response) => {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/entrevistas/parecer-entrevista-tecnica/`, this.form.parecer_tecnica)
                .then((response) => {
                    let data = response.data
        ...
        alterar() {
            ...
            axios
                .put(`${URL_ADMIN}/entrevistas/parecer-entrevista-tecnica/${this.form.parecer_tecnica.id}`, this.form.parecer_tecnica)
                .then((response) => {
                    let data = response.data
                    mostraSucesso('', 'Entrevista salva com sucesso!')
                    this.$refs.janelaParecerEntrevista?.fecharModal()
