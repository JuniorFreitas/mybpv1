...
const app = createApp({
    ...
    computed: {
        ...
        comRh() {
            return this.lista.filter((item) => {
                return item.parecer_rh
            })
        },
        tudoMarcado() {
            let totalItens = this.comRh.length
    ...
    methods: {
        exportaExcel() {
            ...
            axios
                .post(`${URL_ADMIN}/entrevistas/parecer_rh/export`, {
        ...
        formEntrevistar(id) {
            ...
            formReset()
            axios
                .get(`${URL_ADMIN}/entrevistas/parecer_rh/${id}/editar`)
                .then((response) => {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/entrevistas/parecer_rh/`, this.form)
                .then((response) => {
                    let data = response.data
        ...
        alterar() {
            ...
            axios
                .put(`${URL_ADMIN}/entrevistas/parecer_rh/${this.form.parecer_rh.id}`, this.form)
                .then((response) => {
                    let data = response.data
                    mostraSucesso('', 'Entrevista salva com sucesso!')
                    this.$refs.janelaParecerEntrevista?.fecharModal()
