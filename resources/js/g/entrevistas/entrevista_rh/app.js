...
const app = createApp({
    ...
    methods: {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/entrevistas/entrevista-rh/`, this.form)
                .then((response) => {
                    let data = response.data
        ...
        alterar() {
            ...
            axios
                .put(`${URL_ADMIN}/entrevistas/entrevista-rh/${this.form.parecer_rh.entrevista_rh.id}`, this.form.parecer_rh.entrevista_rh)
                .then((response) => {
                    let data = response.data
                    mostraSucesso('', 'Entrevista salva com sucesso!')
                    this.$refs.janelaParecerEntrevista?.fecharModal()
