    ...
    <div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" :disabled="preload || disabled" v-show="obrigatorio" v-mascara:cep class="form-control"
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-5">
                <div class="form-group">
                    ...
                    <input type="text" :disabled="preload || disabled" v-show="obrigatorio" class="form-control"
            ...
            <div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                <div class="form-group">
                    <label>Número</label>
                    <input type="text" :disabled="preload || disabled" class="form-control"
        ...
        <div class="row">
            ...
            <div class="col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                <div class="form-group">
                    <label>UF</label>
                    <input type="text" :disabled="preload || disabled" v-show="obrigatorio" maxlength="2" class="form-control"
                           placeholder="UF"
                           v-model="model.uf"
