                ...
                <table class="tabela">
                    ...
                    <tr v-for="avaliadortipo in lista" :key="avaliadortipo.id">
                        ...
                        <td class="text-center">
                            <bt-ativo :rota="`cadastro/avaliacoes/avaliadortipo/${avaliadortipo.id}/ativa-desativa`"
...
export default {
    ...
    data() {
        return {
            ...
            titulo_janela_form: 'Tipos de Avaliadores',
            ...
            urlPaginacao: `${URL_ADMIN}/cadastro/avaliacoes/avaliadortipo/atualizar`,
            controle: {
                carregando: false,
                dados: {
                    campoBusca: '',
