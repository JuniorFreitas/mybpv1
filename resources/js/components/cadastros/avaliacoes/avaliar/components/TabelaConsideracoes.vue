<template>
    <table class="table" v-if="hasValidData && hasAvaliadores">
        <thead>
        <tr>
            <th
                v-for="(avaliador, id) in avaliadores"
                :key="avaliador.id"
                class="text-center"
            >
                    <span>
        ...
        <tr>
            <td
                v-for="(avaliador, avalIndex) in avaliadores"
