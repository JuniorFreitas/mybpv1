<template>
    <div id="componenteTreinamentoSgi">
        <modal id="janelaCadastrar" :titulo="titulo_janela" :fechar="!preload" :size="90" ref="modal_janelaCadastrar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input v-model="form.titulo_certificado" class="form-control" type="text" onblur="valida_campo_vazio(this, 1)" />
                                </div>
                            </div>
                            <div class="col-12 col-md-12">
                                <div class="form-group">
            ...
            <template #rodape>
                <button type="button" class="btn btn-sm mr-1 btn-primary" v-show="editando" @click="alterarformTreinamentoSgi()">Salvar</button>
                        ...
                        <tr v-for="(item, index) in lista" :key="item.id || index">
                            ...
                            <td class="text-center">
                                <button
                                    ...
                                    @click="alterarTreinamentoSgi(item.id); $refs.modal_janelaCadastrar && $refs.modal_janelaCadastrar.abrirModal()"
                                >
...
export default {
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.preload = true
            axios
                .post(`${URL_ADMIN}/cadastro/treinamentosgi`, this.form)
                .then((res) => {
                    if (res.status === 201) {
        ...
        alterarTreinamentoSgi(treinamentosgi) {
            ...
            axios
                .get(`${URL_ADMIN}/cadastro/treinamentosgi/${treinamentosgi}/editar`)
                .then((response) => {
        ...
        alterarformTreinamentoSgi() {
            ...
            axios
                .put(`${URL_ADMIN}/cadastro/treinamentosgi/${this.form.id}`, this.form)
                .then((response) => {
                    this.$refs.modal_janelaCadastrar && this.$refs.modal_janelaCadastrar.fecharModal()
