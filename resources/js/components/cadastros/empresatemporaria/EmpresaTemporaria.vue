<template>
    <div :id="hash">
        <modal id="janelaCadastrar" :titulo="titulo_janela" :fechar="!preload" :size="90">
            ...
            <template #rodape>
                <button type="button" class="btn btn-sm btn-primary" v-show="editando && !preload" @click="alterarformEmpresaExame()">Alterar</button>
                    ...
                    <tbody>
                        <tr v-for="item in lista">
                            ...
                            <td class="text-center">
                                <bt-ativo :rota="`cadastro/empresa-temporaria/${item.id}/ativa-desativa`" :model="item"></bt-ativo>
                            </td>
                            <td class="text-center">
                                <button
                                    type="button"
                                    ...
                                    data-toggle="modal"
                                    data-target="#janelaCadastrar"
                                    @click="alterarEmpresaExame(item.id)"
                                >
...
export default {
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.preload = true
            axios
                .post(`${URL_ADMIN}/cadastro/empresa-temporaria`, this.form)
                .then((res) => {
                    if (res.status === 201) {
        ...
        alterarEmpresaExame(empresatemporaria) {
            ...
            axios
                .get(`${URL_ADMIN}/cadastro/empresa-temporaria/${empresatemporaria}/editar`)
                .then((response) => {
        ...
        alterarformEmpresaExame() {
            ...
            axios
                .put(`${URL_ADMIN}/cadastro/empresa-temporaria/${this.form.id}`, this.form)
                .then((response) => {
                    $('#janelaCadastrar').modal('hide')
