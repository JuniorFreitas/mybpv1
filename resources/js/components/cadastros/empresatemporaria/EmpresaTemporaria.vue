            ...
            <div class='row'>
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  ...
                  <input v-model='form.razao_social' class='form-control' type='text'
              ...
              <div class='col-12 col-md-4'>
                <div class='form-group'>
                  <label>E-mail</label>
                  <input v-model='form.dados.email' class='form-control' type='text' onblur='validaEmailVazio(this)'
      ...
      <div class='table-responsive' v-show='!controle.carregando && lista.length > 0'>
        <table class='tabela'>
          ...
          <tr v-for='item in lista'>
            ...
            <td class='text-center'>{{ item.razao_social }}</td>
            <td class='text-center'>{{ item.dados.endereco.endereco_completo }}</td>
            <td class='text-center'>
              <bt-ativo :rota='`cadastro/empresa-temporaria/${item.id}/ativa-desativa`'
                        :model='item'></bt-ativo>
            </td>
            <td class='text-center'>
...
export default {
  ...
  data() {
    return {
      ...
      urlPaginacao: `${URL_ADMIN}/cadastro/empresa-temporaria/atualizar`,
      controle: {
        carregando: false,
        dados: {
          campoBusca: ''
  ...
  methods: {
    ...
    cadastrar() {
      ...
      this.preload = true
      axios.post(`${URL_ADMIN}/cadastro/empresa-temporaria`, this.form)
        .then(res => {
          if (res.status === 201) {
    ...
    alterarEmpresaExame(empresatemporaria) {
      this.cadastrado = false
      this.editando = true
      ...
      axios.get(`${URL_ADMIN}/cadastro/empresa-temporaria/${empresatemporaria}/editar`)
        .then(response => {
    ...
    alterarformEmpresaExame() {
      ...
      axios.put(`${URL_ADMIN}/cadastro/empresa-temporaria/${this.form.id}`, this.form).then(response => {
        $('#janelaCadastrar').modal('hide')
