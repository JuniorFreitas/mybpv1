                                ...
                                <div :id="`collapse${objperg.id}`" class="collapse" :aria-labelledby="objperg.id"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-12 mt-2 mb-2"
                                             ...
                                             v-for="(obj, index) in form.perguntas[ind].respostas" :key="obj.id">

                                            <fieldset>
                                                <legend>Opção {{ index + 1 }}</legend>

                                                <editor :api-key="tinyProva.key"
                                                        v-model="obj.resposta" :init="tinyProva"></editor>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-12 mt-3 mb-2">
                                                        <button class="btn btn-sm btn-danger mt-2 mb-2"
                                                                @click="removerLIResposta(ind, index)">
                                                            Remover opção
                                                        </button>

                                                        <button class="btn btn-sm btn-primary mt-2 mb-2 ml-2"
                ...
                <table class="tabela">
                    ...
                    <tr v-for="item in lista">
                        ...
                        <td class="text-center">
                            <bt-ativo :rota="`cadastro/provas/${item.id}/ativa-desativa`"
                                      :model="item"></bt-ativo>
                        </td>
                        <td class="text-center">
...
export default {
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.preload = true;
            axios.post(`${URL_ADMIN}/cadastro/provas`, this.form)
                .then(res => {
                    if (res.status === 201) {
        ...
        alterarForm(simulado) {
            ...
            axios.get(`${URL_ADMIN}/cadastro/provas/${simulado.id}/editar`)
                .then(response => {
        ...
        alterar() {
            ...
            axios.put(`${URL_ADMIN}/cadastro/provas/${this.form.id}`, this.form).then(response => {
                $("#janelaCadastrar").modal("hide");
