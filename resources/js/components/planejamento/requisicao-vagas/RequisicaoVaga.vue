...
<div class="container-fluid requisicao-vaga-page">
    <modal id="janelaCadastrar" :titulo="tituloJanela" :size="90">
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4" v-if="form.outras_informacoes.processo === 'Indicação'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" :disabled="visualizar"
                                                   onblur="valida_campo_vazio(this,1)" v-model="form.outras_informacoes.nome_indicacao">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label>Tipo <span class="text-danger">*</span></label>
                                            <select v-model="form.outras_informacoes.contrato" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <autocomplete :caminho="'autocomplete/todos-gestores-ativos'" :formsm="false"
                                                         :valido="form.outras_informacoes.gestor_id !== ''"
                                                         v-model="form.outras_informacoes.autocomplete_label_gestor"
                                                         placeholder="Digite o nome do(a) gestor(a)" :disabled="visualizar"
                                                         :id="`gestor_${hash}`" @onblur="resetaCampoGestor" @onselect="selecionaGestor"></autocomplete>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label>Cargo está no PPRA e PCMSO? <span class="text-danger">*</span></label>
                                            <select v-model="form.outras_informacoes.ppra" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.outras_informacoes.salario" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-4" v-if="form.outras_informacoes.salario === 'exceção'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" onblur="valida_dinheiro(this)" :disabled="visualizar"
                                                   v-mascara:dinheiro v-model="form.outras_informacoes.salario_valor_format">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            <label>Benefício <span class="text-danger">*</span></label>
                                            <select v-model="form.outras_informacoes.beneficio" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.outras_informacoes.treinamento" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4" v-for="campo in camposCustom" :key="campo.id">
                                        <div class="form-group" v-if="campo.tipo === 'sim_nao'">
                                            ...
                                            <select v-model="form.custom_values[campo.id]" class="form-control" :disabled="visualizar"
                                                    onchange="valida_campo_vazio(this,1)" onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                        ...
                                        <div class="form-group" v-else-if="campo.tipo === 'texto'">
                                            <label>{{ campo.label }}<span class="text-danger" v-if="campo.obrigatorio"> *</span></label>
                                            <input type="text" class="form-control" :disabled="visualizar" onblur="valida_campo_vazio(this,1)"
                                                   v-model="form.custom_values[campo.id]" :placeholder="campo.label">
                                        </div>
                                        <div class="form-group" v-else-if="campo.tipo === 'textarea'">
                                            <label>{{ campo.label }}<span class="text-danger" v-if="campo.obrigatorio"> *</span></label>
                                            <textarea class="form-control" rows="3" :disabled="visualizar" onblur="valida_campo_vazio(this,1)"
                                                      v-model="form.custom_values[campo.id]" :placeholder="campo.label"></textarea>
                                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onblur="valida_campo_vazio(this,1)" :disabled="visualizar" v-model="form.solicitante">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                ...
                <fieldset v-if="aprovando || (visualizar && form.status_aprovacao)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Observação</label>
                                <textarea class="form-control form-control-sm" :disabled="!aprovando" v-model="form.obs_aprovacao" cols="5" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Status</label>
                                <select :disabled="!aprovando" v-model="form.status_aprovacao" class="form-control form-control-sm validacampo"
                                        onchange="valida_campo_vazio(this, 1)" onblur="valida_campo_vazio(this, 1)">
                                    <option value="">Selecione...</option>
                ...
                <fieldset v-if="(aprovandoExtra || (visualizar && form.status_aprovacao_extra)) && temAprovacaoExtra">
                    ...
                    <div class="row" v-if="temAprovacaoExtra">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Observação</label>
                                <textarea class="form-control form-control-sm" :disabled="!aprovandoExtra || aprovandoRh"
                                          v-model="form.obs_aprovacao_extra" cols="5" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Status</label>
                                <select :disabled="!aprovandoExtra || aprovandoRh" v-model="form.status_aprovacao_extra"
                ...
                <fieldset v-if="aprovandoRh || (visualizar && form.status_aprovacao_rh)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Status</label>
                                <select :disabled="!aprovandoRh" v-model="form.status_aprovacao_rh" class="form-control form-control-sm validacampo"
                                        onchange="valida_campo_vazio(this, 1)" onblur="valida_campo_vazio(this, 1)">
                                    <option value="">Selecione...</option>
                                    <option value="aprovado">Aprovar</option>
                                    <option value="reprovado">Reprovar</option>
        ...
        <template slot="rodape">
            <div>
                ...
                <button type="button" class="btn btn-sm btn-primary" v-show="aprovando && !editando && !form.data_aprovacao && !cadastrando" @click.prevent="aprovar">
    ...
    <fieldset>
        ...
        <form class="row" @submit.prevent="$refs.componente && $refs.componente.buscar()">
            <date-range-filter
    ...
    <div id="conteudo">
                        ...
                        <div class="dropdown show">
                            ...
                            <div class="dropdown-menu dropdown-menu-custom dropdown-menu-right"
                                ...
                                <a class="dropdown-item" href="javascript://" title="Aprovação Gestor" data-toggle="modal" data-target="#janelaCadastrar"
                                   ...
                                   v-if="!item.data_aprovacao && aprovaGestor">Aprovação Gestor</a>
                                <a class="dropdown-item" href="javascript://" :title="nomeAprovacaoExtra" data-toggle="modal" data-target="#janelaCadastrar"
                                   ...
                                   v-if="temAprovacaoExtra && item.status_aprovacao === 'aprovado' && !item.status_aprovacao_extra && aprovaExtra">{{ nomeAprovacaoExtra }}</a>
                                <a class="dropdown-item" href="javascript://" title="Aprovação RH" data-toggle="modal" data-target="#janelaCadastrar"
                                   ...
                                   v-if="((item.status_aprovacao === 'aprovado' && !temAprovacaoExtra) || (item.status_aprovacao_extra === 'aprovado')) && !item.rh_aprovacao_id && aprovaRh">Aprovação RH</a>
                                <a class="dropdown-item" href="javascript://" title="Visualizar" data-toggle="modal" data-target="#janelaCadastrar"
                                   @click.prevent="formOpen(item.id); visualizar = true; editando = false; aprovando = false; aprovandoExtra = false; aprovandoRh = false; cadastrando = false">Visualizar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="fluxo-icons">
                        ...
                        <div class="fluxo-step">
                            ...
                            <div class="fluxo-info">
                                ...
                                <small v-if="item.status_aprovacao === 'aprovado'" class="fluxo-aprovador text-success">{{ item.user_aprovacao ? item.user_aprovacao.nome : '' }}</small>
                                <small v-else-if="item.status_aprovacao === 'reprovado'" class="fluxo-aprovador text-danger">{{ item.user_aprovacao ? item.user_aprovacao.nome : '' }}</small>
                        ...
                        <template v-if="temAprovacaoExtra">
                            ...
                            <div class="fluxo-step">
                                ...
                                <div class="fluxo-info">
                                    ...
                                    <small v-else-if="item.status_aprovacao_extra === 'aprovado'" class="fluxo-aprovador text-success">{{ item.aprovacao_extra_nome }}</small>
                                    <small v-else-if="item.status_aprovacao_extra === 'reprovado'" class="fluxo-aprovador text-danger">{{ item.aprovacao_extra_nome }}</small>
                        ...
                        <div class="fluxo-step">
                            ...
                            <div class="fluxo-info">
                                ...
                                <small v-if="item.status_aprovacao === 'reprovado' || (temAprovacaoExtra && item.status_aprovacao_extra === 'reprovado')" class="fluxo-status text-secondary">Cancelada por reprovação</small>
                                <small v-else-if="item.status_aprovacao_rh === 'aprovado'" class="fluxo-aprovador text-success">{{ item.rh_aprovacao_nome }}</small>
                                <small v-else-if="item.status_aprovacao_rh === 'reprovado'" class="fluxo-aprovador text-danger">{{ item.rh_aprovacao_nome }}</small>
        ...
        <controle-paginacao class="d-flex justify-content-center" id="controle" ref="componente"
            :url="urlAtualizar" por-pagina="50" :dados="controle.dados"
...
export default {
    ...
    data() {
        return {
            ...
            selecionaTudo: false,
            form: {
                id: '', centro_custo_id: '', empresa_id: '',
                cargo_id: '', autocomplete_label_cargo_modal: '', autocomplete_label_cargo_modal_anterior: '',
                area_id: '', quantidade: '', tipo_contratacao: '', prioridade: '', imediata: false,
                previsao_inicio: '', solicitante: '', observacao: '', status_aprovacao: '',
                aprovacao_extra_id: '', aprovacao_extra_nome: '', obs_aprovacao_extra: '', status_aprovacao_extra: '', data_aprovacao_extra: '',
                rh_aprovacao_id: '', rh_aprovacao: '', obs_rh: '', status_aprovacao_rh: '', data_aprovacao_rh: '',
                outras_informacoes: {
                    posicao: '', processo: '', contrato: '', local_trabalho: '', horario: '',
                    gestor: '', gestor_id: '', autocomplete_label_gestor: '', autocomplete_label_gestor_anterior: '',
                    nome_indicacao: '', ppra: '',
                    salario: '', salario_valor: '', salario_valor_format: '', beneficio: '', beneficio_excecao: '',
            ...
            controle: {
                ...
                dados: {
                    ...
                    autocomplete_label_anterior: '', autocomplete_label: '', pages: 20,
                    campoBusca: '', campoVaga: '', campoFiltro: '', campoStatus: '', cliente_custom: '',
                    filtroPeriodo: false, dataInicio: '', dataFim: '', ordenacao: 'created_at_desc'
                }
            }
        };
    },
    ...
    methods: {
        carregarCamposCustom() {
            ...
            axios.get(`${base}/planejamento/requisicao-vaga/campos-custom`)
                .then((r) => { this.camposCustom = r.data || []; })
                .catch(() => { this.camposCustom = []; });
        },
        ...
        formOpen(id) {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.get(`${base}/planejamento/requisicao-vaga/${id}/editar`)
                .then((response) => {
        ...
        cadastrar() {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.post(`${base}/planejamento/requisicao-vaga/`, this.form)
                .then(() => {
        ...
        alterar() {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.put(`${base}/planejamento/requisicao-vaga/${this.form.id}`, this.form)
                .then(() => {
        ...
        aprovar() {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.put(`${base}/planejamento/requisicao-vaga/${this.form.id}/aprovar`, this.form)
                .then(() => {
        ...
        aprovarExtra() {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.put(`${base}/planejamento/requisicao-vaga/${this.form.id}/aprovarextra`, this.form)
                .then(() => {
                    if (typeof mostraSucesso === 'function') mostraSucesso('', 'Registro salvo com sucesso!');
                    $('#janelaCadastrar').modal('hide');
                    this.$refs.componente.buscar();
        ...
        aprovarRh() {
            ...
            this.preload = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.put(`${base}/planejamento/requisicao-vaga/${this.form.id}/aprovarrh`, {
                id: this.form.id,
                ...
                .then(() => {
                    if (typeof mostraSucesso === 'function') mostraSucesso('', 'Registro salvo com sucesso!');
                    $('#janelaCadastrar').modal('hide');
                    if (this.$refs.componente && typeof this.$refs.componente.buscar === 'function') this.$refs.componente.buscar();
                    this.preload = false;
                })
                .catch((error) => {
                    this.preload = false;
        ...
        listaAreasEtiquetas() {
            ...
            axios.get(`${base}/lista-areas`).then((res) => { this.areas_etiquetas = res.data.areas || []; }).catch(() => {});
        },
        listaCentroCusto() {
            const base = typeof URL_PUBLICO !== 'undefined' ? URL_PUBLICO : '';
            axios.post(`${base}/centro-custos/`, { empresa_id: this.form.empresa_id })
                .then((res) => { this.centro_custos = res.data.centro_custos || []; })
                .catch(() => { this.preload = false; });
        },
        usuarioAutenticado() {
            this.controle.carregando = true;
            const base = typeof URL_ADMIN !== 'undefined' ? URL_ADMIN : '';
            axios.get(`${base}/usuario/autenticado/`)
                .then((response) => {
...
.requisicao-vaga-page .status-reprovado { background: #dc3545; color: white; }
.requisicao-vaga-page .status-aprovado { background: #28a745; color: white; }
.requisicao-vaga-page .status-aprovado-extra { background: #17a2b8; color: white; }
.requisicao-vaga-page .status-aprovado-gestor { background: #ffc107; color: #212529; }
.requisicao-vaga-page .status-pendente { background: #e9ecef; color: #495057; }
...
.requisicao-vaga-page .detail-label { font-weight: 500; color: #6c757d; white-space: nowrap; }
.requisicao-vaga-page .detail-value { color: #212529; font-weight: 400; }
...
@media (max-width: 768px) {
    ...
    .requisicao-vaga-page .card-left { width: 100%; }
    .requisicao-vaga-page .card-right {
        width: 100%;
        justify-content: space-between;
    }
