    ...
    <div>
            ...
            <template slot="conteudo">
                ...
                <form v-if="!preload && !cadastrado && !atualizado" :id="`form_${hash}`" onsubmit="return false;">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <autocomplete :caminho="`autocomplete/colaboradores`" :formsm="true"
                                        :valido="form.colaborador_id !== ''"
                                        v-model="form.autocomplete_label_colaborador"
                                        placeholder="Selecione um(a) colaborador(a)"
                                        :disabled="visualizar || aprovandoRh || aprovando" :id="`colaborador_${hash}`"
                                        @onblur="resetaCampoColaborador" @onselect="selecionaColaborador">
                                    </autocomplete>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.anterior_centro_custo_id" class="form-control form-control-sm"
                                        disabled>
                            ...
                            <div class="col-12 col-md-1" v-if="centroCustoTemFilial">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.anterior_filial" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-md-5" v-if="temFilial && form.anterior_filial">
                                <div class="form-group">
                                    <label>Filial</label>
                                    <select v-model="form.anterior_centro_custo_filial_id" class="form-control"
                                        disabled>
                                        <option value="">Selecione</option>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <autocomplete :disabled="true" :caminho="caminho_autocomplete_vagas"
                                        ...
                                        v-model="form.autocomplete_label_vaga_anterior" placeholder="Vaga Atual"
                                        @onblur="resetaCampoNovoCargo" @onselect="selecionaVaga"></autocomplete>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        onblur="valida_campo_vazio(this,2)" v-model="form.anterior_funcao" disabled />
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" v-mascara:dinheiro
                                        v-model="form.anterior_salario" disabled />
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4" v-if="!form.mantem_centro_custo">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.novo_centro_custo_id" class="form-control form-control-sm"
                                        @change.prevent="changeCentroCusto()" onchange="valida_campo_vazio(this,1)"
                            ...
                            <div class="col-12 col-md-2" v-if="centroCustoTemFilialNovo && !form.mantem_centro_custo">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.novo_filial" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-md-4"
                                ...
                                <div class="form-group">
                                    ...
                                    <select v-model="form.novo_centro_custo_filial_id"
                        ...
                        <div class="row">
                            <div class="col-12 col-md-2" v-if="form.anterior_funcao">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm"
                                        @change.p.prevent="changeMantemFuncao()" v-model="form.mantem_funcao"
                                        :disabled="visualizar || aprovandoRh || aprovando">
                                        <option :value="true">Sim</option>
                                        <option :value="false">Não</option>
                                    </select>
                            ...
                            <div class="col-12 col-md-6" v-if="!form.mantem_funcao">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        onblur="valida_campo_vazio(this,2)" v-model="form.nova_funcao"
                                        :disabled="visualizar || aprovandoRh || aprovando" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm"
                                        @change.p.prevent="changeTreinamentoFuncao()" v-model="form.treinamento_funcao"
                                        :disabled="visualizar || aprovandoRh || aprovando">
                                        <option :value="false">Não</option>
                                        <option :value="true">Sim</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" @change.p.prevent="changeMantemCargo()"
                                        v-model="form.mantem_cargo" :disabled="visualizar || aprovandoRh || aprovando">
                                        <option :value="true">Sim</option>
                                        <option :value="false">Não</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-md-6" v-if="!form.mantem_cargo">
                                <div class="form-group">
                                    ...
                                    <autocomplete :caminho="caminho_autocomplete_vagas"
                                        ...
                                        v-model="form.autocomplete_label_vaga_nova" placeholder="Novo Cargo"
                                        @onselect="selecionaVagaNovo"
                                        :disabled="visualizar || aprovandoRh || aprovando"></autocomplete>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm"
                                        @change.p.prevent="changeMantemSalario()" v-model="form.mantem_salario"
                                        :disabled="visualizar || aprovandoRh || aprovando">
                                        <option :value="true">Sim</option>
                                        <option :value="false">Não</option>
                                    </select>
                    ...
                    <fieldset v-if="form.colaborador_id">
                        ...
                        <div class="row">
                            <gestoraprovacao formsm :model="form" :verifica="visualizar || aprovandoRh || aprovando"
                                :hash="hash_gestor" obrigatorio :disabled="visualizar || aprovandoRh || aprovando">
                            </gestoraprovacao>
                        </div>
                    </fieldset>
                    <fieldset v-if="form.colaborador_id">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" v-model="form.obs_solicitante"
                                        cols="5" rows="5" :disabled="visualizar || aprovandoRh || aprovando"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 mt-4 mb-4" v-if="visualizar">
                                <legend>Solicitação feita por: {{ form.solicitante !== null ? form.solicitante.nome : ''
                                }} {{ form.data_solicitacao }}</legend>
                            </div>
                        </div>
                    </fieldset>

                    <div class="alert alert-warning" v-if="aprovando">Esta solicitação ainda não foi aprovada ou
                        reprovada!</div>
                    ...
                    <fieldset v-if="visualizar || aprovando || aprovandoRh">
                        ...
                        <div class="row">
                            <div v-if="!aprovando && form.gestor_aprovacao" class="col-12">
                                <legend>
                                    {{ form.status_aprovacao_gestor }} por: {{ form.gestor_aprovacao.nome }} em
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" :disabled="!aprovando || aprovandoRh"
                                        v-model="form.obs_gestor_aprovacao" cols="5" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Status</label>
                                    <select :disabled="!aprovando || aprovandoRh" v-model="form.status_aprovacao_gestor"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm"
                                        :disabled="visualizar && !aprovando && !aprovandoRh" v-model="form.obs_rh"
                    ...
                    <fieldset v-if="form.colaborador_id">
                        ...
                        <upload :model="form.anexos" :model-delete="form.anexosDel" :url="url_anexo" :tipos="mimes"
                            :leitura="!podeanexar" label="Selecionar" @onProgresso="anexoUploadAndamento = true"
                            @onFinalizado="anexoUploadAndamento = false"></upload>
                    </fieldset>
                </form>
            </template>
            ...
            <form class="row" @submit.prevent="$refs.componente.buscar()">
                <div class="col-12 col-md-3">
                    <div class="form-check" style="margin-bottom: -11px">
                        <input type="checkbox" class="form-check-input" @change="atualizar()"
                            :disabled="controle.carregando" id="filtroIntervalo"
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Buscar por colaborador" autocomplete="off"
                ...
                <div class="col-12 col-md-9">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                        :disabled="controle.carregando" :data-target="`#${hash}`" @click.prevent="formNovo">
                        Solicitar
                    </button>
                    <button type="button" class="btn btn-sm btn-primary mr-1" @click.prevent="exportaExcel()"
                    ...
                    <button type="submit" class="btn btn-sm btn-primary mr-1" v-show="selecionados.length > 0"
                        ...
                        :disabled="selecionados.length === 0" data-toggle="modal" data-target="#janelaAtualizaStatus">
        ...
        <div class="mb-2 mt-2 pt-1 pb-1 border-bottom bg-white" v-show="!controle.carregando && lista.length > 0">
            <span class="text-right ml-2">
                Legenda:
                <i class="fas fa-circle text-light ml-2"></i> Em aberto <i class="fas fa-circle text-warning ml-2"></i>
                Aprovado
                pelo Gestor
                <i class="fas fa-circle text-success ml-2"></i> Aprovado pelo RH <i
                    class="fas fa-circle text-danger ml-2"></i>
                Reprovado
            </span>
        </div>
                                ...
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-custom dropdown-menu-right"
                                        ...
                                        <a class="dropdown-item" href="javascript://" title="Aprovação Gestor"
                                            data-toggle="modal" :data-target="`#${hash}`" @click.prevent="
                                                formOpen(item.id)
                                            cadastrando = false
                                            visualizar = false
                                            aprovando = true
        ...
        <controle-paginacao class="d-flex justify-content-center" id="controle" ref="componente" :url="urlPaginacao"
            :por-pagina="controle.dados.pages" :dados="controle.dados" v-on:carregou="carregou"
...
export default {
    ...
    methods: {
        ...
        aprovarGestor() {
            ...
            axios
                .put(`${URL_ADMIN}/planejamento/movimentacao/mudanca-cargo/${this.form.id}/aprovargestor`, this.form)
                .then((response) => {
                    let data = response.data
