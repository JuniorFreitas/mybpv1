    ...
    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" v-model="form.obs" cols="5" rows="5" :disabled="visualizar"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mb-2 mt-2 pt-1 pb-1 border-bottom" v-show="!controle.carregando && lista.length > 0">
            <span class="small text-right">
                Legenda:
                <i class="fas fa-circle text-warning ml-2"></i> Aguardando Aprovação <i class="fas fa-circle text-info ml-2"></i> Aprovado pelo Gestor
                        ...
                        >
                            ...
                            <td>
                                <span class="text-uppercase" v-if="item.user_aprovacao || item.rh_aprovacao">
                                    <span v-if="item.status_aprovacao === 'aprovado' && item.status_aprovacao_rh === null">
                                    ...
                                    <span v-if="item.status_aprovacao === 'reprovado' && item.status_aprovacao_rh === null">
                                        {{ item.status_aprovacao }} em {{ item.data_aprovacao }}<br />
                                        Por gestor(a): {{ item.user_aprovacao.nome }}
                                    </span>
