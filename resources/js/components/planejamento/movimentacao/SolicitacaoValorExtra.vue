...
export default {
    ...
    methods: {
        ...
        cadastrar() {
            ...
            axios.post(`${URL_ADMIN}/planejamento/movimentacao/valor-extra-prevista`, this.form)
                .then(response => {
        ...
        formOpen(id) {
            ...
            axios.get(`${URL_ADMIN}/planejamento/movimentacao/valor-extra-prevista/${id}/editar`)
                .then(response => {
                    let data = response.data;
        ...
        alterar() {
            ...
            axios.put(`${URL_ADMIN}/planejamento/movimentacao/valor-extra-prevista/${this.form.id}`, this.form)
                .then(response => {
                    $(`#${this.hash} `).modal('hide');
                    let data = response.data;
        ...
        aprovar() {
            ...
            this.preload = true;
            axios.put(`${URL_ADMIN}/planejamento/movimentacao/valor-extra-prevista/${this.form.id}/aprovar`, this.form)
                .then(response => {
                    let data = response.data;
