<template>
    <div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" onblur="valida_campo_vazio(this, 1)" v-model="formTipo.label" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <date-picker :disabled="encerrado" :range="true" label="Data da Convocação" v-model="form.data_lancamento"></date-picker>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select :disabled="encerrado" v-model="form.centro_custo_id" class="form-control">
                                    <option value="">Selecione</option>
                        ...
                        <div class="col-12" v-if="editando">
                            <div class="form-group">
                                ...
                                <autocomplete
                                    ...
                                    @onselect="selecionaColaboradorUnico"
                                ></autocomplete>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Ação</label>
                                <input type="text" class="form-control" :disabled="encerrado" onblur="valida_campo_vazio(this, 1)" v-model="form.acao" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" :disabled="encerrado" v-model="form.obs_lancamento" cols="3" rows="3"></textarea>
                            </div>
                        </div>
        ...
        <div class="col-12 mb-2 mt-2 pt-1 pb-1 border-bottom">
            <span class="small">
                Legenda:
                <i class="fas fa-circle text-warning"></i> Aberto <i class="fas fa-circle text-success ml-2"></i> Convocação Encerrada
            </span>
        </div>

        <p class="text-center" v-if="controle.carregando"><i class="fa fa-spinner fa-pulse"></i> Carregando...</p>
...
export default {
    ...
    methods: {
            ...
            if (this.form.autocomplete_label_colaborador_anterior !== this.form.autocomplete_label_colaborador) {
                ...
                setTimeout(() => {
                    if (this.form.feedback_id === '') {
                        ...
                        $('#janelaCadastrar #colaborador_' + this.hash)
                            .focus()
                            .trigger('blur')
        ...
        formNovoProrrogacao(id) {
            ...
            axios
                .get(`${URL_ADMIN}/apontamento/intermitente/prorrogacao/${id}/editar`)
                .then((response) => {
        ...
        cadastrarProrrogacao() {
            ...
            axios
                .post(`${URL_ADMIN}/apontamento/intermitente/prorrogacao`, this.formProrrogacao)
                .then((response) => {
        ...
        cadastrar() {
            ...
            axios
                .post(`${URL_ADMIN}/apontamento/intermitente`, this.form)
                .then((response) => {
                    if (response.status === 201) {
                        this.preloadAjax = false
                        this.cadastrado = true
        ...
        visualizar(id) {
            ...
            axios
                .get(`${URL_ADMIN}/apontamento/intermitente/${id}/editar`)
                .then((response) => {
        ...
        visualizarTreinamentos(colaborador) {
            ...
            axios
                .get(`${URL_ADMIN}/apontamento/intermitente/${colaborador.id}/treinamentos`)
                .then((response) => {
        ...
        confirmaEncerraConvocacao() {
            ...
            axios
                .put(`${URL_ADMIN}/apontamento/intermitente/encerrar-convocacao/${this.form.id}`, this.form)
                .then((response) => {
                    this.preloadAjax = false
        ...
        cadastraTipo() {
            ...
            axios
                .post(`${URL_ADMIN}/apontamento/intermitente/storeTipo`, this.formTipo)
                .then((res) => {
        ...
        editarTipo(tipo) {
            ...
            axios
                .get(`${URL_ADMIN}/apontamento/intermitente/tipo/editar/${tipo}`)
                .then((response) => {
