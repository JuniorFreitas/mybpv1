        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <button v-if="!visualizar" class="btn btn-sm mr-1 btn-secondary mb-2" @click="add()">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2 col-lg-2">
                                ...
                                >
                                    <option v-for="cont in 30" :key="cont" :value="cont" v-show="cont >= 5">
                                        {{ cont }}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row" v-show="model.length > 0">
                            <div class="col-12 mb-3">
                                <button
                                    ...
                                    class="btn btn-sm mr-1 btn-danger mb-2 mr-1"
                                    type="button"
