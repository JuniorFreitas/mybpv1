<template>
    <div>
        ...
        <modal :fechar="!preloadSalvar" id="janelaAvaliacao" size="g" modal-pai="janelaHistorico" titulo="Avaliacao Anual">
            <template #conteudo>
        ...
        <div v-if="!preload" :id="`form_${hash}`">
            <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#janelaAvaliacao" @click="addFNDias">
