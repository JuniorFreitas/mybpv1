<template>
    <div>
        ...
        <modal ref="modalBeneficio" :fechar="!preload" id="janelaBeneficio" size="g" modal-pai="janelaHistorico" titulo="Benefício">
            ...
            <template #rodape>
                <button class="btn btn-primary" v-if="!preload" @click="salvar"><i class="fa fa-save"></i> Salvar</button>
            </template>
        </modal>
...
export default {
    ...
    methods: {
        ...
        salvar() {
            ...
            //criar
            axios
                .post(`${URL_ADMIN}/historico/beneficio/${this.feedback_id}`, this.form)
                .then((response) => {
