        ...
        <div v-if="!preload" :id="`form_${hash}`">
            <fieldset>
                ...
                <upload
                    ...
                    :model="form.doc_selecao"
                    :model-delete="form.doc_selecaoDel"
                    :url="urlAnexoUpload"
            ...
            <fieldset>
                <legend>DOCUMENTOS CHECK LIST ADMISSÃO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'DocChecklist',
                    ...
                    :model="form.doc_checklist"
                    :model-delete="form.doc_checklistDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>FICHA REGISTRO ASSINADA</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.ficha_registrada"
                    :model-delete="form.ficha_registradaDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model-delete="form.autodeclaracao_etnico_racialDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model="form.contrato_trabalho_assinado"
                    :model-delete="form.contrato_trabalho_assinadoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>TERMO DE CONFIDENCIALIDADE ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.termo_confiabilidade"
                    :model-delete="form.termo_confiabilidadeDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>OPÇÃO VALE TRANSPORTE ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.vale_transporte_assinado"
                    :model-delete="form.vale_transporte_assinadoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>ACORDO COMPENSAÇÃO DE HORAS ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'AcordoHora',
                    ...
                    :model="form.acordo_hora"
                    :model-delete="form.acordo_horaDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>TERMO SALÁRIO FAMILIA ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.salario_familia_assinado"
                    :model-delete="form.salario_familia_assinadoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>DECLARAÇÃO DEPENDENTES IMPOSTO DE RENDA ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.declaracao_dependentes_imposto"
                    :model-delete="form.declaracao_dependentes_impostoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>COMPROVANTE DEVOLUÇÃO CTPS ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.comprovante_dev_ctp"
                    :model-delete="form.comprovante_dev_ctpDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>ORDEM DE SERVIÇO ASSINADA</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.ordem_servico_assinada"
                    :model-delete="form.ordem_servico_assinadaDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>CERTIFICADOS DE TREINAMENTOS SEGURANÇA</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.certificado_trein_seg"
                    :model-delete="form.certificado_trein_segDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>FICHA DE ENTREGA DE EPI</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.ficha_entrega_epi"
                    :model-delete="form.ficha_entrega_epiDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>CONTRACHEQUES MENSAIS</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.contra_cheque_mensais"
                    :model-delete="form.contra_cheque_mensaisDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>CARTÕES DE PONTO MENSAIS</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'CartoesPonto',
                    ...
                    :model="form.cartoes_ponto"
                    :model-delete="form.cartoes_pontoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>AVISOS DE FÉRIAS ANUAIS</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'AvisoFerias',
                    ...
                    :model="form.aviso_ferias"
                    :model-delete="form.aviso_feriasDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>PASTA DE CONTROLE DE ASOS: ADMISSIONAIS, PERIODICOS,MUDANÇA DE FUNÇÃO, DEMISSIONAL</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'ControleAsos',
                    ...
                    :model="form.controle_asos"
                    :model-delete="form.controle_asosDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>BOOK DE RESCISÃO – CHECK LIST DEMISSÃO:</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'BookRescisao',
                    ...
                    :model="form.book_rescisao"
                    :model-delete="form.book_rescisaoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>TERMO DE RESCISAO DE CONTRATO DE TRABALHO ASSINADO</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'TermoRescisao',
                    ...
                    :model="form.termo_rescisao"
                    :model-delete="form.termo_rescisaoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>GUIAS DE SEGURO DESEMPREGO ASSINADAS</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.guia_seguro_desemprego"
                    :model-delete="form.guia_seguro_desempregoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>CHAVE DE FGTS ASSINADA</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                        tipo: 'ChaveFgts',
                    ...
                    :model="form.chave_fgts"
                    :model-delete="form.chave_fgtsDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model="form.comprovante_pagamento"
                    :model-delete="form.comprovante_pagamentoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>EXAME DEMISSIONAL</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.exame_demissional"
                    :model-delete="form.exame_demissionalDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                <legend>NADA CONSTA DE BAIXA E FICHA DE ENTREGA DE EPI</legend>
                <upload
                    label="Selecionar anexo(s)"
                    :dados-ajax="{
                    ...
                    :model="form.nada_consta_ficha_epi"
                    :model-delete="form.nada_consta_ficha_epiDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model="form.comprovante_devolucao_ctps"
                    :model-delete="form.comprovante_devolucao_ctpsDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model="form.ppp_assinado"
                    :model-delete="form.ppp_assinadoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model-delete="form.arquivamento_eletronicoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model-delete="form.arquivamento_dossieDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
            ...
            <fieldset>
                ...
                <upload
                    ...
                    :model-delete="form.plano_saude_assinadoDel"
                    :url="urlAnexoUpload"
                    @onprogresso="anexoUploadAndamento = true"
                    @onfinalizado="anexoUploadAndamento = false"
                ></upload>
