...
<template>
    <div>
        <button class="btn btn-sm btnFormAlterar btn-success" @click.prevent="ativaDesativa()"
           v-if="model.ativo"
        ...
        <button class="btn btn-sm btnFormAlterar btn-danger" @click.prevent="ativaDesativa()"
           v-if="!model.ativo"
           :disabled="model.preload">
    ...
    export default {
        ...
        methods: {
            ativaDesativa: function () {
                ...
                axios.put(`${URL_ADMIN}/${this.rota}`, {id: this.model.id})
                .then(response => {
