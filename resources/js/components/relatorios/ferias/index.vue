            ...
            <fieldset>
                ...
                <form class="row">
                    <div class="col-12 col-md-3">
                        ...
                        <select class="form-control form-control-sm" :disabled="preload" v-model="filtrar.tipo" @change="buscarDados()">
                    ...
                    <div class="col-12 col-md-3" v-if="filtrar.tipo === 'data'">
                        <datepicker
                            range
                            formsm
                            label="Escolha a data de saida:"
                            :disabled="preload"
                            @onselect="buscarDados()"
                            v-model="filtrar.periodo_range"
                        ></datepicker>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mb-2">
                        ...
                        <select class="form-control form-control-sm" :disabled="preload" @change="buscarDados()" v-model="filtrar.status_ferias">
                            ...
                            <option v-for="(item, index) in filtro.status_ferias" :value="item" :key="index">{{ letterCase(item) }}</option>
                        </select>
                    </div>
                            ...
                            <table class="mt-4 table table-bordered table-striped">
                                <thead>
                                    <tr class="bg-white text-center">
                                        <th rowspan="4" style="display: table-cell; vertical-align: middle; text-align: center; /* Não necessário */">
                                            {{ index + 1 }}
                                        </th>
