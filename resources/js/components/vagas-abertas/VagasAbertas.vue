                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-2 text-muted"><i class="fas fa-map-marker-alt"></i>
                            {{ dados_vaga.municipio.nome }} - {{ dados_vaga.municipio.uf }}
                        </p>
                        <div class="float-md-left">
                            <a href="javascript://" data-toggle="modal"
                               data-target="#janelaCadastrar"
                               class="btn mr-1 mb-2 btn-primary"
                    ...
                    <div v-if="exibiFormulario">
                        ...
                        <div class="alert alert-success alert-dismissible" v-show="cadastrado">
                            <p style="font-size: 1.2rem" class="text-center"><i class="icon fa fa-check"></i>
                                A confirmação do seu cadastro foi enviada por e-mail, verifique sua CAIXA DE ENTRADA ou
                                LIXO
                                ELETRÔNICO/SPAM.
                                <br>
                        ...
                        <form v-if="!preloadAjax && (!cadastrado && !atualizado)" id="form">
                            <p class="alert alert-warning">
                                ATENÇÃO: Cadastre um E-mail válido, pois e-mail inválido ou inexistente desclassificará
                                o
                                candidato.
                            </p>
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" v-model="form.rg_data_emissao"
                                                   placeholder="Ex: 10/10/2010"
                                                   autocomplete="mastertag" v-mascara:data
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" v-model="form.naturalidade"
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" onchange="valida_campo_vazio(this,1)"
                                                    onblur="valida_campo_vazio(this,1)" v-model="form.sexo">
                            ...
                            <fieldset class="table-warning">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-lg-12 col-xl-12">
                                        <telefones :model="form.telefones" :model-delete="form.telefonesDelete"
                                                   :pais="false"
                                                   :ramal="false"></telefones>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset v-if="form.temexperiencia">
                                ...
                                <div class="row" v-show="form.experiencias.length>0"
                                     v-for="(obj, index) in form.experiencias" :key="obj.id"
                            ...
                            <fieldset v-if="form.temqualificacao">
                                ...
                                <div class="row" v-show="form.qualificacoes.length>0"
                                     v-for="(obj, index) in form.qualificacoes" :key="obj.id"
                                     style="margin-bottom: 13px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="form.disponibilidade_sabado"
                                                    onchange="valida_campo_vazio(this,1)"
                                                    onblur="valida_campo_vazio(this,1)">
                                                <option value="">Selecione</option>
                                                <option :value="true">Sim</option>
                ...
                <template slot="rodape">
                    <div v-show="exibiFormulario">
                        <button type="button" class="btn btn-primary"
                                v-show="!editando && !cadastrado && !atualizado && !preloadAjax"
                                @click="cadastrar">
...
export default {
    ...
    methods: {
        atualizar() {
            axios.post(`${URL_SITE}/api/${this.empresa_id}/vaga-aberta/${this.vaga_aberta_id}`)
                .then(response => {
        ...
        buscaCurriculo() {
            ...
            if (this.form.cpf.length === 14 && this.form.nascimento.length === 10) {
                ...
                axios.post(`${URL_SITE}/api/busca-curriculo`, {
                    cpf: this.form.cpf,
        ...
        cadastrar() {
            ...
            axios.post(`${URL_SITE}/api/cadastra-curriculo`, this.form)
                .then(response => {
                    this.preloadAjax = false;
                    if (this.possuiCadastro) {
        ...
        buscaCpf() {
            ...
            if (this.form.cpf.length === 14) {
                axios.post(`${URL_SITE}/api/busca-cpf/`, {cpf: this.form.cpf})
                    .then(response => {
                        let data = response.data;
                        if (data.length > 0) {
                            this.form.cpf = '';
                            ...
                            mostraErro('', `CPF ${data[0].cpf} já cadastrado em nossa base de dados com outro e-mail ou data de nascimento em ${dataFormatada} às ${Hora}h,
