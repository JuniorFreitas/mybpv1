                            ...
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cnpj" class="form-control" placeholder="CNPJ"
                                           v-model="form.dados.cnpj" :disabled="editando" autocomplete="off"
                                           v-mascara:cnpj>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="form.dados.razao_social"
                            ...
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="form.dados.nome_fantasia"
                            ...
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.dados.area_id" class="form-control"
                            ...
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    <label>Ramo</label>
                                    <input type="text" class="form-control" v-model="form.dados.ramo"
                                           placeholder="Ramo"
                                           autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Telefone" v-mascara:telefone
                ...
                <table class="tabela">
                    ...
                    <tr v-for="item in lista">
                        ...
                        <td class="text-center">
                            <bt-ativo :rota="`administracao/clientes/filial/${item.id}/ativa-desativa`"
                                      :model="item"></bt-ativo>
                        </td>
                        <td class="text-center">
                            <button type="button" class="btn btn-sm btn-primary mb-1" data-toggle="modal"
                                    data-target="#janelaFilialCadastrar" @click="alterarFilial(item.id)">
...
export default {
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.preload = true;
            axios.post(`${URL_ADMIN}/administracao/clientes/filial`, this.form)
                .then(res => {
        ...
        alterarFilial(filial) {
            ...
            this.form = _.cloneDeep(this.formDefault) //copia
            this.preload = true;
            axios.get(`${URL_ADMIN}/administracao/clientes/filial/${filial}/editar`)
                .then(response => {
        ...
        alterarform() {
            ...
            axios.put(`${URL_ADMIN}/administracao/clientes/filial/${this.form.id}`, this.form).then(response => {
                $('#janelaFilialCadastrar').modal('hide');
