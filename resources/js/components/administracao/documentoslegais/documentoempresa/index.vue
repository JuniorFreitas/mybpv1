                    ...
                    <div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select
                                        ...
                                        :disabled="editando"
                                        @change.prevent="valida_campo_vazio($event.target, 1); form.documentos_empresa.tipo_descricao = ''"
                        ...
                        <div v-if="form.tipo_empresa !== ''">
                            <ul class="nav nav-tabs bg-light" id="tabslist" role="tablist" style="border-bottom: 1px solid #653232">
                                <li class="nav-item">
                                    <a
                                        ...
                                        id="nav-documentoempresa-tab"
                                        href="#nav-documentoempresa"
                                        role="tab"
                                        aria-controls="nav-documentoempresa"
                                        aria-selected="false"
                                        data-toggle="tab"
                                        >DOCUMENTO LEGAIS
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        id="nav-config-empresa-tab"
                                        href="#nav-config-empresa"
                                        role="tab"
                                        aria-controls="nav-config-empresa"
                                        aria-selected="false"
                                        data-toggle="tab"
                                        >CONFIGURAÇÕES</a
                                    >
                            ...
                            <div class="tab-content py-3 p-2">
                                <div class="tab-pane show active" id="nav-documentoempresa" role="tabpanel" aria-labelledby="nav-documentoempresa-tab">
                                    <fieldset>
                                                ...
                                                <div class="row py-3">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                v-model="form.documentos_empresa.tipo_id"
                                                                class="form-control validacampo"
                                                                @change.prevent="valida_campo_vazio($event.target, 1)"
                                                                onblur="valida_campo_vazio(this, 1)"
                                                            >
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                class="form-control"
                                                                v-model="form.documentos_empresa.observacao"
                                                                rows="3"
                                                                cols="3"
                                                            ></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <upload
                                                                        :model="form.documentos_empresa.anexos"
                                ...
                                <div class="tab-pane fade" id="nav-config-empresa" role="tabpanel" aria-labelledby="nav-config-empresa-tab">
                                    <fieldset>
                                        <legend class="text-uppercase">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                <div class="form-group" v-if="permissoes.whatsapp">
                                                    ...
                                                    <select
                                                        v-model="form.documentos_empresa.envia_whatsapp"
                                                        class="form-control validacampo"
                                                        onblur="valida_campo_vazio(this, 1)"
                                                        @change.prevent="valida_campo_vazio($event.target, 1)"
                                                    >
                    ...
                    <tbody>
                        <tr v-for="(item, index) in lista" :key="item.id || index">
                            ...
                            <td data-label="Referente">
                                {{
                                    item.contrato_id
                                        ? item.contrato.dados_cadastrais.nome
                                            ? item.contrato.dados_cadastrais.nome
                                            : item.contrato.dados_cadastrais.razao_social
                            ...
                            <td data-label="Status">
                                <bt-ativo
                                    :rota="`administracao/documentoslegais/empresa/${item.id}/ativa-desativa`"
                                    :model="item.documentos_empresa"
                                ></bt-ativo>
                            </td>

                            <td data-label="Ações">
                                <a
                                    :href="`empresa/${item.id}/pdf`"
                                    v-if="permissoes.pdf"
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.$nextTick(() => {
                ...
                $('#nav-documentoempresa :input:enabled.is-invalid').length > 0
                    ? $('#nav-documentoempresa-tab').addClass('bg-danger text-white')
                    : $('#nav-documentoempresa-tab').removeClass('bg-danger text-white')
                $('#nav-config-empresa :input:enabled.is-invalid').length > 0
                    ? $('#nav-config-empresa-tab').addClass('bg-danger text-white')
                    : $('#nav-config-empresa-tab').removeClass('bg-danger text-white')
                ...
                axios
                    .post(`${URL_ADMIN}/administracao/documentoslegais/empresa`, this.form)
                    .then((response) => {
        ...
        formAlterar(id) {
            ...
            axios
                .get(`${URL_ADMIN}/administracao/documentoslegais/empresa/${id}/editar`)
                .then((response) => {
        ...
        alterar() {
            ...
            this.$nextTick(() => {
                ...
                axios
                    .put(`${URL_ADMIN}/administracao/documentoslegais/empresa/${this.form.id}`, this.form)
                    .then((response) => {
