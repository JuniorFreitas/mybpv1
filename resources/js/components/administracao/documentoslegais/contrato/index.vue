                ...
                <form v-if="!preloadAjax && !cadastrado && !atualizado" id="form" onsubmit="return false">
                    <div>
                        ...
                        <div class="tab-content py-3 p-2">
                            <div class="tab-pane fade show active" id="nav-dados-cadastrais" role="tabpanel" aria-labelledby="nav-dados-cadastrais-tab">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                <label>Tipo</label>
                                                <select class="form-control" v-model="form.dados_cadastrais.tipo" :disabled="editando">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                            <div class="form-group" v-if="form.dados_cadastrais.tipo === 'Pessoa Jurídica'">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="CNPJ"
                                                    v-model="form.dados_cadastrais.cnpj"
                                                    :disabled="editando"
                                                    autocomplete="off"
                                                    @keyup.prevent="valida_cnpj_vazio($event.target)"
                                            ...
                                            <div class="form-group" v-if="form.dados_cadastrais.tipo === 'Pessoa Física'">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control validacampo"
                                                    placeholder="CPF"
                                                    v-model="form.dados_cadastrais.cpf"
                                                    :disabled="editando"
                                                    autocomplete="off"
                                                    @keyup.prevent="valida_cpf_vazio($event.target)"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6 col-xl-6" v-if="form.dados_cadastrais.tipo === 'Pessoa Jurídica'">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    v-model="form.dados_cadastrais.area_id"
                                                    class="form-control validacampo"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <fieldset>
                                                ...
                                                <telefone
                                                    :model="form.dados_cadastrais.telefones"
                                                    :ramal="false"
                                                    :pais="false"
                                                    :model-delete="form.dados_cadastrais.telefonesDelete"
                                                ></telefone>
                                            </fieldset>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <upload
                                                            :model="form.dados_cadastrais.logo"
                                                            ...
                                                            @onFinalizado="logoUploadAndamento = false"
                                                        ></upload>
                                                    </div>
                                                </div>
                                            </fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        >
                                            ...
                                            :key="obj.id">
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group">
                                                        <datepicker label="Data Vencimento" posicao="up" v-model="obj.data_encerramento"></datepicker>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-6 col-lg-4">
                                                    ...
                                                    <select
                                                        class="form-control validacampo"
                                                        v-model="obj.select_tipo_servico"
                                                        @change.prevent="valida_campo_vazio($event.target, 1)"
                                                        onblur="valida_campo_vazio(this, 1)"
                                                    >
                                                        <option value="">Selecione ...</option>
                ...
                <table class="tabela">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in lista" :key="item.id || index">
                            ...
                            <td data-label="Nome">
                                {{ item.dados_cadastrais.tipo == 'Pessoa Física' ? item.dados_cadastrais.nome : item.dados_cadastrais.razao_social }}
                            </td>
                            ...
                            <td data-label="Status">
                                <bt-ativo :rota="`administracao/documentoslegais/contrato/${item.id}/ativa-desativa`" :model="item"></bt-ativo>
                            </td>
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.$nextTick(() => {
                ...
                $('#nav-dados-cadastrais :input:enabled.is-invalid').length > 0
                    ? $('#nav-dados-cadastrais-tab').addClass('bg-danger text-white')
                    : $('#nav-dados-cadastrais-tab').removeClass('bg-danger text-white')
                $('#nav-service :input:enabled.is-invalid').length > 0
                    ? $('#nav-service-tab').addClass('bg-danger text-white')
                    : $('#nav-service-tab').removeClass('bg-danger text-white')
                ...
                axios
                    .post(`${URL_ADMIN}/administracao/documentoslegais/contrato`, this.form)
                    .then((response) => {
        ...
        alterar() {
            ...
            this.$nextTick(() => {
                ...
                axios
                    .put(`${URL_ADMIN}/administracao/documentoslegais/contrato/${this.form.id}`, this.form)
                    .then((response) => {
