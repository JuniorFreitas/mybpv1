        ...
        <div id="conteudo">
            ...
            <div class="table-responsive" v-show="!controle.carregando && lista.length > 0">
                <table class="tabela">
                    ...
                    <tbody>
                        <tr v-for="(tiposervico, index) in lista" :key="tiposervico.id || index">
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-sm mr-1 btn-primary" v-if="permissoes.update" @click="alterar(tiposervico.id)">
