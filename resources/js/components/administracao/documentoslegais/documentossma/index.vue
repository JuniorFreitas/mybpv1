                    ...
                    <div>
                        ...
                        <div v-if="form.tipo_ssma !== ''">
                            ...
                            <div class="tab-content py-3 p-2">
                                <div class="tab-pane show active" id="nav-documentossma" role="tabpanel" aria-labelledby="nav-documentossma-tab">
                                    <fieldset>
                                                ...
                                                <div class="row py-3">
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group">
                                                            <datepicker
                                                                label="Data Início"
                                                                posicao="up"
                                                                v-model="form.documentos_ssma.data_inicio"
                                                            ></datepicker>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group">
                                                            <datepicker
                                                                ...
                                                                posicao="up"
                                                                v-model="form.documentos_ssma.data_encerramento"
                                                            ></datepicker>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-12 col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                v-model="form.documentos_ssma.tipo_id"
                                                                class="form-control validacampo"
                                                                @change.prevent="valida_campo_vazio($event.target, 1)"
                                                                onblur="valida_campo_vazio(this, 1)"
                                                            >
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                class="form-control"
                                                                v-model="form.documentos_ssma.observacao"
                                                                rows="3"
                                                                cols="3"
                                                            ></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <upload
                                                                        :model="form.documentos_ssma.anexos"
                                ...
                                <div class="tab-pane fade" id="nav-config-ssma" role="tabpanel" aria-labelledby="nav-config-ssma-tab">
                                    <fieldset>
                                        <legend class="text-uppercase">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                <div class="form-group" v-if="permissoes.whatsapp">
                                                    ...
                                                    <select
                                                        v-model="form.documentos_ssma.envia_whatsapp"
                                                        class="form-control validacampo"
                                                        @keyup.prevent="valida_campo_vazio($event.target, 1)"
                                                        onblur="valida_campo_vazio(this, 1)"
                                                    >
                    ...
                    <tbody>
                        <tr v-for="item in lista">
                            ...
                            <td data-label="Status">
                                <bt-ativo :rota="`administracao/documentoslegais/ssma/${item.id}/ativa-desativa`" :model="item.documentos_ssma"></bt-ativo>
                            </td>
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.$nextTick(() => {
                ...
                $('#nav-documentossma :input:enabled.is-invalid').length > 0
                    ? $('#nav-documentossma-tab').addClass('bg-danger text-white')
                    : $('#nav-documentossma-tab').removeClass('bg-danger text-white')
                $('#nav-config-ssma :input:enabled.is-invalid').length > 0
                    ? $('#nav-config-ssma-tab').addClass('bg-danger text-white')
                    : $('#nav-config-ssma-tab').removeClass('bg-danger text-white')
                ...
                axios
                    .post(`${URL_ADMIN}/administracao/documentoslegais/ssma`, this.form)
                    .then((response) => {
        ...
        alterar() {
            ...
            this.$nextTick(() => {
                ...
                axios
                    .put(`${URL_ADMIN}/administracao/documentoslegais/ssma/${this.form.id}`, this.form)
                    .then((response) => {
