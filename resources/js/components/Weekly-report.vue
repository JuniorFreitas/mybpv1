    ...
    <div class="mt-4">
        ...
        <modal id="janelaApagarQuadro" :fechar="!formApagarQuadro.preload" :modal-pai="modalPai" titulo="Excluir quadro">
            <template #conteudo>
                ...
                <div v-show="!formApagarQuadro.preload && !formApagarQuadro.delete && !formApagarQuadro.erro" class="alert alert-warning" role="alert">
                ...
                <div v-show="!formApagarQuadro.preload && formApagarQuadro.delete && !formApagarQuadro.erro" class="alert alert-success" role="alert">
                    <h4 class="text-center">
                ...
                <div v-show="!formApagarQuadro.preload && !formApagarQuadro.delete && formApagarQuadro.erro" class="alert alert-danger" role="alert">
                    <h4 class="text-center">
        ...
        <modal id="janelaApagarListaTarefa" :fechar="!formApagarLista.preload" :modal-pai="modalPai" titulo="Excluir lista de tarefas">
            <template #conteudo>
                ...
                <div v-show="!formApagarLista.preload && !formApagarLista.delete && !formApagarLista.erro" class="alert alert-warning" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-exclamation-triangle"></i><br />
                ...
                <div v-show="!formApagarLista.preload && formApagarLista.delete && !formApagarLista.erro" class="alert alert-success" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-check"></i><br />
                        A lista foi apagada
                    </h4>
                ...
                <div v-show="!formApagarLista.preload && !formApagarLista.delete && formApagarLista.erro" class="alert alert-danger" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-times-circle"></i><br />
                        {{ formApagarLista.msg }}
                    </h4>
        ...
        <modal id="janelaApagarTarefa" :fechar="!formApagarTarefa.preload" :modal-pai="modalPai" titulo="Excluir tarefa">
            <template #conteudo>
                ...
                <div v-show="!formApagarTarefa.preload && !formApagarTarefa.delete && !formApagarTarefa.erro" class="alert alert-warning" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-exclamation-triangle"></i><br />
                ...
                <div v-show="!formApagarTarefa.preload && formApagarTarefa.delete && !formApagarTarefa.erro" class="alert alert-success" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-check"></i><br />
                ...
                <div v-show="!formApagarTarefa.preload && !formApagarTarefa.delete && formApagarTarefa.erro" class="alert alert-danger" role="alert">
                    <h4 class="text-center">
                        <i class="fas fa-times-circle"></i><br />
        ...
        <modal v-if="TAREFA" id="janelaTarefa" :fechar="!formTarefa.preload" :modal-pai="modalPai" :titulo="TAREFA.titulo" size="g" topo>
            <template #topo>
                <input
                    ...
                    ref="campoTituloTarefa"
                    v-model="TAREFA.titulo"
                    class="form-control"
                    type="text"
                    @blur="updateTarefa"
                    @mouseover="$refs.campoTituloTarefa.focus()"
                    @keydown.enter="updateTarefa"
                />
                <h3 v-else class="modal-title" @click="tarefa_update ? (tarefaEditandoTitulo = !tarefaEditandoTitulo) : false">
                    {{ TAREFA.titulo }}
                </h3>
                <p>
                    na lista <span class="text-primary">{{ LISTA.titulo }}</span>
                </p>
            </template>
            <template #conteudo>
                ...
                <div v-if="!formTarefa.preload" class="row">
                    <div class="col-12 col-sm-9">
                        ...
                        <div v-if="TAREFA.membros && TAREFA.membros.length > 0" class="row mb-3">
                            ...
                            <div class="col-11">
                                ...
                                <span v-for="(membro, index) in TAREFA.membros" class="dropdown mb-1">
                                    ...
                                    <div aria-labelledby="dropdownMenuLink" class="dropdown-menu dropdown-menu-custom mb-1">
                                        <div class="card" style="width: 300px">
                                            <div class="card-header">Detalhes do membro</div>
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    <div class="col-2">
                                                        <a
                                                ...
                                                <button class="btn btn-danger btn-sm btn-block" type="button" @click="removerMembro(membro)">
                                                    Remover da tarefa
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <span class="dropdown mb-1">
                                    ...
                                    <div aria-labelledby="dropdownMenuLink" class="dropdown-menu dropdown-menu-custom mb-1">
                                        <div class="card" style="width: 300px">
                                            <div class="card-header">Adicionar membros</div>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <autocomplete
                                                        v-model="autoCompleteNovoMembros"
                        ...
                        <div v-if="TAREFA.datahora_inicio != null || TAREFA.datahora_entrega != null" class="row mb-3">
                            <div class="col-12">
                                <h4>
                                    ...
                                    <span
                                        v-if="!TAREFA.concluido && TAREFA.datahora_entrega != null && TAREFA.emAtraso"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div v-if="TAREFA.datahora_inicio != null" class="col-12 col-sm-4">
                                        ...
                                        <datepicker v-model="TAREFA.datahora_inicio" :hora="true" label="" @onselect="addDataHoraInicio"></datepicker>
                                        <button class="btn btn-danger btn-sm btn-block" type="button" @click="removerDataHoraInicio">Remover</button>
                                    </div>
                                    <div v-if="TAREFA.datahora_entrega != null" class="col-12 col-sm-4">
                                        <div class="card-title text-center">
                                            ...
                                            />
                                            <label class="form-check-label font-weight-lighter" for="checkboxDataEntrega">Data de entrega</label>
                                        </div>
                                        <datepicker v-model="TAREFA.datahora_entrega" :hora="true" label="" @onselect="addDataHoraEntrega"></datepicker>
                                        <button class="btn btn-danger btn-sm btn-block" type="button" @click="removerDataHoraEntrega">Remover</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-11 text-left">
                                <div class="form-group">
                                    <p
                                        v-if="TAREFA.descricao !== '' && !tarefaEditandoDescricao"
                                        v-html="formatDescricao(TAREFA.descricao)"
                                        @click="toggleDescricaoEdicao"
                                    ></p>
                                    <div
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                        ...
                                                        <a :href="anexo.urlDownload" class="tarefa" target="_blank">
                                                            ...
                                                            >
                                                                ...
                                                                <g>
                                                                    ...
                                                                    <text style="font-size: 130px; fill: #ffffff" x="45" y="380">{{ anexo.extensao }}</text>
                                                                </g>
                                                                <path
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            ...
                                                            <div v-if="anexo.enviando" class="progress animated-progess mb-4">
                                                                <div
                                                                    :aria-valuenow="anexo.pctProgresso"
                                                            ...
                                                            <div v-if="!anexo.enviando" class="card-text">
                                                                <div class="dropdown mb-1">
                                                                    ...
                                                                    <div aria-labelledby="dropdownMenuLink" class="dropdown-menu mb-1">
                                                                        <div class="card" style="width: 300px">
                                                                            <div class="card-header">Vincular nome</div>
                                                                            <div class="card-body">
                                                                                <div class="form-group">
                                                                                    <input
                                                                ...
                                                                -
                                                                <span class="dropdown mb-1">
                                                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button"> Excluir </a>
                                                                    <div aria-labelledby="dropdownMenuLink" class="dropdown-menu mb-1">
                                                                        <div class="card" style="width: 300px">
                                                                            <div class="card-header">Excluir anexo?</div>
                                                                            <div class="card-body">
                                                                                <p class="card-text">
                                                            ...
                                                            <small v-if="!anexo.enviando" class="text-muted">Adcionado: {{ anexo.created_at }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <!--    Check list  -->
                        <draggable
                            :model-value="TAREFA.checklists"
                            item-key="id"
                            class="col-12"
                            draggable=".listaChecklist"
                            ghost-class="placeholder"
                            group="listaChecklist"
                            handle=".listaChecklist"
                            @update:model-value="TAREFA.checklists = $event"
                            @change="moveuCheckList"
                        >
                            <template #item="{ element: checklist, index }">
                                <div class="row mb-3 listaChecklist">
                                    <!--  Topo -->
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-1">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <h4
                                                    v-if="checklistIdEditando == null || checklistIdEditando !== checklist.id"
                                    ...
                                    <div class="col-12">
                                        <div class="progress animated-progess mb-4">
                                            <div
                                                :aria-valuenow="infoProgresso(checklist).pct"
                                    ...
                                    <div class="col-12 mb-2">
                                        <draggable
                                            ...
                                            group="itemChecklist"
                                            handle=".item"
                                            @update:model-value="checklist.itens = $event"
                                            @change="moveuItem"
                                            @start="podeMoverItem = true"
                                            @end="podeMoverItem = true"
                                            :move="() => podeMoverItem"
                                        >
                                                ...
                                                <div class="row item">
                                                    <div class="col-12 col-sm-10">
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                class="form-check-input"
                                                                type="checkbox"
                                                                @change="updateItemConcluir(item)"
                                                            />
                                                            <div v-if="checklistItemIdEditando != null && ITEM_ID === item.id" class="form-group">
                                                                <input
                                                                    :ref="`campoInputItem${item.id}`"
                                                                    v-model="ITEM.titulo"
                                                                    class="form-control"
                                                            ...
                                                            <label
                                                                v-if="
                                                                    (checklistItemIdEditando == null && ITEM_ID == null) ||
                                                                    (checklistItemIdEditando != null && ITEM_ID !== item.id)
                                                                "
                                                                :class="{ textoRiscado: item.concluido }"
                                                                class="form-check-label"
                                                                @mouseup="abriFormItem(item)"
                                                                >{{ item.titulo }}</label
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-2">
                                                        <div class="dropdown mb-1">
                                                            ...
                                                            <div aria-labelledby="dropdownMenuLink" class="dropdown-menu mb-1">
                                                                <div class="card" style="width: 300px">
                                                                    <div class="card-header text-center">Excluir o item ?</div>
                                                                    <div class="card-body">
                                                                        <p class="card-text">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div v-if="formItem.id == null && formItem.checklist_id === checklist.id" class="form-group">
                                                        <input
                                                            :ref="`formNovoItemChecklist${CHECKLIST.id}`"
                                ...
                                <div class="row">
                                    <div class="media mt-2 ml-2" v-for="atividade in TAREFA.logs">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="card-text">
                                                <strong>{{ atividade.usuario.nome }}</strong>
                                                {{ atividade.descricao }}
                                                <br />
                    ...
                    <div class="col-12 col-sm-3">
                        ...
                        <div class="dropdown mb-1">
                            ...
                            <div aria-labelledby="dropdownMenuLink" class="dropdown-menu mb-1">
                                <div class="card" style="width: 300px">
                                    <div class="card-header">Adicionar Checklist</div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Título</label>
                        ...
                        <button
                            :disabled="TAREFA.datahora_inicio != null"
                            class="btn btn-light btn-sm btn-block mb-1 text-left"
                            type="button"
                        ...
                        <button
                            :disabled="TAREFA.datahora_entrega != null"
                            class="btn btn-light btn-sm btn-block mb-1 text-left"
                            type="button"
                        ...
                        >
                            <template v-slot:template>
                                <button class="btn btn-light btn-sm btn-block mb-1 text-left" type="button"><i class="fas fa-paperclip"></i> Anexo</button>
                            </template>
                        </upload>
                        <!-- Lembretes  -->
                ...
                <div class="row">
                    <div v-if="quadro_insert" class="col form-inline">
                        <form @submit.prevent="addQuadro">
                            <input
                                v-model="formQuadros.titulo"
                                :disabled="preloadQuadro"
                                class="form-control form-control-sm"
                                placeholder="Nome do Quadro"
                                type="text"
                            />
                            <button :disabled="formQuadros.titulo === '' || preloadQuadro" class="btn btn-primary btn-sm ml-3" type="submit" @click="addQuadro">
                                <i class="fa fa-plus"></i> Novo quadro
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <div v-for="(quadro, index) in listaQuadros" class="col-md-4">
                        <div class="card mt-3" style="border: 1px solid #cccccc">
                            <h5
                                ...
                                @click="quadro_update ? (alterandoQuadro = quadro) : false"
                            >
                                {{ quadro.titulo }}
                            </h5>
                            <input
                                v-if="alterandoQuadro != null && quadro.id === alterandoQuadro.id"
                                :ref="'card_quadro_' + quadro.id"
                                v-model="quadro.titulo"
                                class="form-control"
                                placeholder="Nome do Quadro"
                                type="text"
                                @blur="updateQuadro"
                ...
                <div class="row">
                    <div class="col-sm-10 col-12">
                        <div class="row mr-1" style="overflow-x: auto; min-height: 80vh">
                            <draggable
                                :model-value="arrayListas"
                                item-key="id"
                                class="d-flex"
                                draggable=".listaTarefa"
                                ghost-class="placeholder"
                                group="listaTarefas"
                                handle=".corpoListaTarefa"
                                @update:model-value="arrayListas = $event"
                                @change="moveuLista"
                            >
                                <!-- elemento lista-->
                                <template #item="{ element: lista, index }">
                                    <div class="flex-fill mr-3 listaTarefa" style="width: 300px; margin-left: 0.8rem !important">
                                        <div class="card corpoListaTarefa" style="border: 1px solid #cccccc">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-10">
                                                        <h4
                                                            v-if="alterandoLista == null || lista.id !== alterandoLista.id"
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div aria-labelledby="dropdownMenuButton" class="dropdown-menu">
                                                                <a
                                                                    ...
                                                                    href="#"
                                                                    @click.prevent="alterandoLista = lista"
                                                                >
                                                ...
                                                <div class="row">
                                                    <draggable
                                                        ...
                                                        group=".tarefas"
                                                        handle=".tarefa"
                                                        @update:model-value="lista.tarefas = $event"
                                                        @change="moveuTarefa"
                                                        @start="podeMoverTarefa = true"
                                                        @end="podeMoverTarefa = true"
                                                        :move="() => podeMoverTarefa"
                                                    >
                                                        <template #item="{ element: tarefa, index }">
                                                            <div class="w-100 tarefa">
                                                                <div
                                                                    :class="{
                                                                        'text-white bg-danger': tarefa.datahora_entrega && tarefa.emAtraso && !tarefa.concluido,
                                                        ...
                                                        <div v-if="tarefa_insert" class="w-100">
                                                            <div
                                                                class="card card-body"
                                                                style="border: 2px dashed #bcb8b8"
                                                                @click.stop="abriFormNovaTarefa(lista)"
                                                            >
                                                                <p
                                                                    v-if="TAREFA != null || formTarefa.lista_id === null || (LISTA && LISTA.id !== lista.id)"
                                                                    class="card-text"
                                                                >
                                                                    <i class="fas fa-tasks"></i>
                                                                    <template v-if="lista.tarefas.length > 0">Adicionar outra tarefa </template>
                                                                    <template v-if="lista.tarefas.length === 0">Adicionar uma tarefa </template>
                                                                </p>
                                                                ...
                                                                >
                                                                    <div class="card-text">
                                                                        <div class="form-group">
                                                                            <textarea
                                                                                :ref="`formNovaTarefa_lista${lista.id}`"
                                ...
                                <!-- Form nova lista-->
                                <div v-if="lista_insert" class="flex-fill mr-3" style="width: 300px; margin-left: 0.8rem !important">
                                    <div class="card card-body" style="border: 2px dashed #cccccc" @click.stop="abriFormNovaLista">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="card-text mt-2">
                                            <strong>{{ atividade.usuario.nome }}</strong> {{ atividade.descricao }}
                                        </p>
                                    </div>
                                </div>
...
export default {
    ...
    mounted() {
        ...
        this.preload = true
        axios
            .get(`${URL_ADMIN}/weekly-report/${this.id}`)
            .then((response) => {
        ...
        // Logs
        Echo.join(`weekly-report.log.${this.id}`).listen('.log', (e) => {
    ...
    methods: {
        formatDescricao(valor) {
            return nl2br(valor)
        },
        formatNome(valor) {
            return formataNome(valor)
        },
        toggleDescricaoEdicao() {
            this.tarefaEditandoDescricao = !this.tarefaEditandoDescricao
            this.aplicarAutoResize()
        },
        handleDescricaoKeydown() {
            this.tarefaEditandoDescricao = true
            this.autoresize()
        },
        //Tela de quadros ------------------
        voltarParaQuadros() {
        ...
        addQuadro() {
            ...
            axios
                .post(`${URL_ADMIN}/weekly-report/${this.id}/quadros`, quadro)
                .then((response) => {
        ...
        deleteQuadro() {
            ...
            axios
                .delete(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.formApagarQuadro.id}`)
                .then((response) => {
                    this.formApagarQuadro.preload = false
        ...
        verQuadro(objQuadro) {
            ...
            this.preload = true
            axios
                .get(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas`)
                .then((response) => {
        ...
        addLista() {
            ...
            this.preload = true
            axios
                .post(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas`, lista)
                .then((response) => {
        ...
        deleteLista() {
            ...
            axios
                .delete(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas/${this.formApagarLista.id}`)
                .then((response) => {
                    this.formApagarLista.preload = false
        ...
        moveuLista(event, originalEvent) {
            ...
            axios
                .put(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas`, { novaLista })
                .then((response) => {
                    //this.arrayListas = response.data.lista;
        ...
        addTarefa() {
            ...
            this.preload = true
            axios
                .post(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas/${this.LISTA.id}/tarefas`, tarefa)
                .then((response) => {
        ...
        deleteTarefa() {
            ...
            axios
                .delete(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas/${this.LISTA.id}/tarefas/${this.formApagarTarefa.id}`)
                .then((response) => {
                    this.formApagarTarefa.preload = false
        ...
        verTarefa(objTarefa, objLista) {
            ...
            axios
                .get(`${URL_ADMIN}/weekly-report/${this.id}/quadros/${this.QUADRO.id}/listas/${this.LISTA.id}/tarefas/${this.TAREFA.id}`)
                .then((response) => {
                    this.TAREFA.logs = []
        ...
        addCheckList() {
            ...
            axios
                .post(`${this.rotaTarefa}/checklist`, {
