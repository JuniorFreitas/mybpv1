    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-10">
            <div class="row">
                ...
                @endif
                @if(auth()->user()->DadosEmpresa->visao)
                    <div class="col-xl-5 col-lg-6 mt-3">
                        <div class="card card-stats mb-4 mb-xl-0 text-white"
                             style="background: url(https://site.bpse.com.br/img/b_blue.png) no-repeat #072333; background-size: cover; min-height: 350px">
                            <div class="card-body">
                ...
                @endif
                @if(auth()->user()->DadosEmpresa->valores)
                    <div class="col-xl-5 col-lg-6 mt-3">
                        <div class="card card-stats mb-4 mb-xl-0 text-white"
                             style="background: url(https://site.bpse.com.br/img/b_blue.png) no-repeat #072333; background-size: cover; min-height: 350px">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="">
                                            {{auth()->user()->DadosEmpresa->valores}}
                ...
                @endif
                @if(auth()->user()->DadosEmpresa->politica_gq)
                    <div class="col-xl-5 col-lg-6 mt-3">
                        <div class="card card-stats mb-4 mb-xl-0 text-white"
                             style="background: url(https://site.bpse.com.br/img/b_blue.png) no-repeat #072333; background-size: cover; min-height: 350px">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-white mt-5 mb-4">POLÍTICA DE GESTÃO DA
                                            QUALIDADE</h5>
                                        <p class="">
                                            {{auth()->user()->DadosEmpresa->politica_gq}}
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12 col-lg-2 d-flex">
            @if(count(auth()->user()->ClientesMascote) > 0)
                <img
                    src="{{auth()->user()->ClientesMascote[0]->url}}"
