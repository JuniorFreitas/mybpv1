    ...
    <fieldset>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3" v-if="cliente_id === 0">
                    <div class="form-group">
                        ...
                        <autocomplete :disabled="controle.carregando"
                                      ...
                                      placeholder="Por cliente" @onblur="resetaCampoCliente"
        ...
        <div class="col-12">
            <div class="row">
                ...
                <form target="_blank" action="{{ route('parecerrh.excel') }}"
                      {{-- action="{{ \App\Models\Sistema::UrlServidor }}/parecer_rh/export/3hmMaxB0QB0zvE48exportsBGQG3bheYiaQP1cWIqdhPL1lbv5g9tWBnBhRUDIJCRFM2gqbZSALev3zPcZVbHlZS" --}} method="get">
                    @csrf
