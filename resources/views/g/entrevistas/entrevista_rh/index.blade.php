...
@section('title', 'Entrevista RH')
@section('content_header','Entrevista RH')
@section('content')
...
{{--                    </button>--}}
    ...
    <div id="conteudo">
                ...
                <td class="text-center" style="width: 1em;">
                    <label :for="entrevista.id">
                        <input
                            ...
                            :value="entrevista.id"
                            :id="entrevista.id"
                            :style="entrevista.parecer_rh.entrevista_rh ? 'cursor:pointer' : 'cursor: not-allowed'"
                            :content="entrevista.parecer_rh.entrevista_rh ? 'Selecionar' : 'Não possui parecer Cadastrado'"
                            v-tippy
                            v-if="entrevista.parecer_rh.entrevista_rh"
                        >
                ...
                <td class="text-center">
                    ...
                    <form :action="`${URL_ADMIN}/entrevistas/entrevista-rh/curriculo/${entrevista.curriculo_id}`" target="_blank" method="get">
                        <button class="btn btn-sm btn-primary mb-2" content="Entrevistar" v-tippy
                                v-show="!entrevista.parecer_rh.entrevista_rh"
        ...
        <controle-paginacao class="d-flex justify-content-center" id="controle" ref="componente"
                            url="{{route('g.entrevista.entrevista_rh_cliente.atualizar')}}"
...
@stop
@push('js')
    <script src="{{mix('js/g/entrevistas/entrevista_rh/app.js')}}"></script>
@endpush
