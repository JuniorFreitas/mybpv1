            ...
            <div v-if="form.tipo_cliente !== ''">
                ...
                <div class="tab-content py-3 p-2">
                    ...
                    <div class="tab-pane fade" id="nav-config"
                        ...
                        <fieldset>
                            <legend class="text-uppercase">Configurações Gerais</legend>
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="form-group">
                        ...
                        <fieldset>
                            <legend class="text-uppercase">Notificações</legend>
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="form-group">
                        ...
                        <fieldset>
                            <legend class="text-uppercase">Rotinas</legend>
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        <label>Schedule de Treinamento Vencimento</label>
                                        <select v-model="form.cliente_config.schedule_treinamento_vencimento" class="form-control">
                                            <option :value="true">Habilitado</option>
                                            <option :value="false">Desabilitado</option>
                                        </select>
                                        <small class="text-muted">Controla o envio/schedule do treinamento vencimento para esta empresa.</small>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Controla o envio/schedule da avaliação de experiência para esta empresa.</small>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        <label>Permitir alterar "Realizou este treinamento?" para Não quando já realizado</label>
                                        <select v-model="form.cliente_config.treinamento_permitir_desmarcar_realizado" class="form-control">
                                            <option :value="false">Desabilitado</option>
                                            <option :value="true">Habilitado</option>
                                        </select>
