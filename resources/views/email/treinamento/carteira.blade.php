...
<head>
    ...
    <title>SGIBPSE :: CARTEIRA E ETIQUETA</title>
    <style type="text/css">
        .footer--btn-confirm {
            width: 200px;
            height: 50px;
    ...
    <tr style="margin-top: 20px;">
        <td valign="top">
            <p style="font-size: 13.5px; line-height: 20px; font-family: 'Arial'; color: #555555">
                ...
                Estamos enviando a sua carteira e a etiqueta, clique no botão abaixo para imprimir.
                <br><br>

                <a href="{{ route('treinamento.carteira',$token) }}" class="link" target="_blank">
                    IMPRIMIR
                </a>
                <br>
                <br>
