...
@section('conteudo')
    ...
    <p class="f14"
       style="text-align: center; font-weight: bold; margin-bottom: 1.5cm; text-transform: uppercase">
        DEMISSÃO SEM JUSTA CAUSA<br> AVISO {{$dados->tipoAviso->descricao}} <br><br>
    ...
    <p class="f12" style="line-height: 22pt;text-align: justify">
        ...
        Cap. VI, Título IV do Decreto Lei n. 5452 de 01/05/1943 (CLT). O aviso prévio de 30 dias será {{$dados->tipo_aviso}}.
    </p>

    @if($dados->tipoAviso->descricao == 'Trabalhado')
        <br><br>
        <p class="f12" style="line-height: 22pt;text-align: justify">
