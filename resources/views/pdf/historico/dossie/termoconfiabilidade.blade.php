...
@section('conteudo')
    ...
    <div style="margin-left: 9px; width: 96%">
        ...
        <p class="f11" style="">
            ...
            data, fornecida pela EMPRESA ou pelo seus Clientes, devendo ser tratada como informação sigilosa.<br>
            ...
            escrita, verbal, digitalizada ou de qualquer outro modo apresentada, tangível ou intangível, virtual ou
            física,
            ...
            preços e custos, contratos, planos de negócios, planos de segurança, processos, projetos, fotografias,
            programas
            de computador, discos, disquetes, fitas, conceitos de produto, instalações, infra-estrutura, especificações,
            amostras de idéias, definições e informações mercadológicas, invenções e idéias, outras informações
            técnicas,
            financeiras ou comerciais, dentre outros, doravante denominados “INFORMAÇÕES CONFIDENCIAIS”, a que,
            diretamente
            ou através de seus Diretores, Clientes, empregados e/ou prepostos, venha o EMPREGADO, ter acesso, seja por
            si
            criada em favor da EMPRESA, conhecimento, ou que venha lhe ser confiadas durante e em razão dos trabalhos
            realizados e do Contrato Principal celebrado entre as PARTES.<br>

            2.3.Compromete-se, outrossim, o EMPREGADO, a não revelar, reproduzir, utilizar ou dar conhecimento, ou
            alugar ou
            vender, em hipótese alguma, a terceiros as INFORMAÇÕES CONFIDENCIAIS.<br>

            2.4.As PARTES deverão cuidar para que as informações confidenciais fiquem restritas a sede da EMPRESA
            durante as
            discussões, análises, reuniões e negócios, trabalhos e projetos.<br>
        ...
        <p class="f11" style="">
            4. CLÁUSULA QUARTA – DA VIGÊNCIA<br>
        ...
        <p class="f11" style="">
            5. CLÁUSULA QUINTA – DAS PENALIDADES<br>

            5.1A quebra do sigilo profissional, devidamente comprovada, sem autorização expressa da EMPRESA,
            possibilitará a
            imediata rescisão de qualquer contrato firmado entre as PARTES, sem qualquer ônus para a EMPRESA. Neste
            caso, o
            EMPREGADO estará sujeito, por ação ou omissão, ao pagamento ou recomposição de todas as perdas e danos
            sofridos
            pela EMPRESA, inclusive as de ordem moral ou concorrencial, bem como as de responsabilidades civil e
            criminal
            respectivas, as quais serão apuradas em regular processo judicial ou administrativo, mais o valor de
            eventuais
            lucros cessantes resultantes de INFORMAÇÕES CONFIDENCIAIS indevidamente transferidas, devidamente corrigidos
            pelo índice determinado pelo Poder Judiciário do Maranhão.<br>

        </p>
        <p class="f11" style="">
            6. CLÁUSULA SEXTA - DAS DISPOSIÇÕES GERAIS<br>
            ...
            negociações
            anteriores ou posteriores, escritas ou verbais, empreendidas pelas PARTES contratantes no que diz respeito
            ao
            Contrato Principal, sejam estas ações feitas direta ou indiretamente pelas PARTES, em conjunto ou
            separadamente,
            e, será igualmente aplicado a todo e qualquer acordo ou entendimento futuro, que venha a ser firmado entre
            as
            PARTES.<br>
            6.2 Este Termo de Confidencialidade constitui termo vinculado ao Contrato Principal, parte independente e
            regulatória daquele.<br>
            ...
            de
            acordo com os princípios de boa fé, da eqüidade, da razoabilidade, e da economicidade e, preencherão as
            lacunas
            com estipulações que, presumivelmente, teriam correspondido à vontade das PARTES na respectiva
            ocasião.<br>

            6.4 O disposto no presente Termo de Confidencialidade prevalecerá, sempre, em caso de dúvida, e salvo
            expressa
            determinação em contrário, sobre eventuais disposições constantes de outros instrumentos conexos firmados
            entre
            as PARTES quanto ao sigilo de informações confidenciais, tal como aqui definida.<br>
