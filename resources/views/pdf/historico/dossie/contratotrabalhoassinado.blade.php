...
@section('conteudo')
    ...
    <p class="f11 text-justify">
        ...
        ({{\App\Models\Sistema::valorPorExtenso($dados['dados_colaborador']->FeedBack->Admissao->salario)}}). A circunstância, porém, de ser
    ...
    <p class="f11 text-justify">
        ...
        <strong>EMPREGADORA</strong>, autorizada a efetivar o desconto da importância correspondente ao prejuízo, o qual
    ...
    <p class="f11 text-justify">
        ...
        @else
            ...
            ({{ \MasterTag\GExtenso::numero($dados['dados_colaborador']->FeedBack->Admissao->pExperiencia()[0]) }}) dias, podendo este ser
            prorrogado ou não por mais {{$dados['dados_colaborador']->FeedBack->Admissao->pExperiencia()[1]}}
            ({{ \MasterTag\GExtenso::numero($dados['dados_colaborador']->FeedBack->Admissao->pExperiencia()[1]) }}) dias sendo celebrado para
            as
    ...
    <p class="f11 text-justify">
        ...
        concessivos, na medida em que um dos períodos de férias não poderá ser inferior a quatorze dias corridos e os
    ...
    <p class="f11 text-justify">
        ...
        direitos da veiculação das imagens em todo e qualquer material entre imagens de vídeo, fotos e documentos, para
        ser utilizada pela empresa <strong>CONTRATANTE</strong> destinado a divulgação ao público em geral não recebendo
        para tanto qualquer tipo de remuneração.
    </p>
    <p class="f11 text-justify">
        <strong>11ª (Rescisão)</strong> – Opera-se a rescisão do presente contrato pela decorrência do prazo supra ou
    ...
    <p class="f11 text-justify">
        <strong>12.2</strong> - O <strong>EMPREGADO</strong> ao assinar o presente contrato, está ciente que a empresa
    ...
    <p class="f11 text-justify">
        <strong>12.3</strong> - Os dados fornecidos pelo <strong>EMPREGADO</strong> serão utilizados para as seguintes
        finalidades:<br>
    ...
    <p class="f11 text-justify">
        Parágrafo Primeiro – Os dados da cláusula 12.3 serão gerados no decorrer do relacionamento entre as partes e do
    ...
    <p class="f11 text-justify">
        <strong>12.9</strong> - Os dados coletados são de acesso exclusivo da <strong>EMPREGADORA</strong>, e não serão
    ...
    <p class="f11 text-justify">
        <strong>12.10</strong> - Se, apesar das medidas de segurança implementadas, houver vazamento de dados que possa
    ...
    <p class="f11 text-justify">
        ...
        ficando a primeira em poder da <strong>EMPREGADORA</strong>, e a segunda com o <strong>EMPREGADO</strong> que
