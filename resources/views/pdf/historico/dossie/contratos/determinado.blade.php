...
@section('conteudo')
    ...
    <div style="margin-left: 9px; width: 95%">
        ...
        <p class="f12 text-justify">
            <strong>1</strong> – O <strong>EMPREGADO(A)</strong> trabalhará para a <strong>EMPREGADORA</strong>, com
            duração
            de ____ Dias, no
        ...
        <p class="f12 text-justify">
            ...
            trabalho, inclusive nos dias destinados ao Descanso Remunerado e feriados, observadas as necessidades
            técnicas
            da <strong>EMPREGADORA</strong>, pelo trabalho em horas suplementares, o <strong>EMPREGADO(A)</strong>
            perceberá
        ...
        <p class="f12 text-justify">
            ...
            a fazer uso obrigatório dos EPIS (EQUIPAMENTO DE PROTEÇÃO INDIVIDUAL), fornecidos gratuitamente pela
            <strong>EMPREGADORA</strong>
            sob pena de ser punido pelo cometimento de falta grave, nos termos da legislação vigente e demais
            disposições
            inerentes a Segurança e medicina Ocupacional.
        </p>
        <p class="f12 text-justify">
            <strong>4.2</strong> - O <strong>EMPREGADO(A)</strong> se obriga a cumprir as normas e regulamentos internos
            da
            <strong>EMPREGADORA</strong>
            ...
            <strong>4.3</strong> - O <strong>EMPREGADO</strong> fica desde já pré-avisado que o término do contrato a
            seu
            termo, não dependerá de qualquer aviso ou notificação prévia.
        </p><br>
        <p class="f12 text-justify">
            <strong>5 – RESCISÃO ANTECIPADA</strong><br>
            O presente CONTRATO poderá ser rescindido antes de expirado o termo ajustado. Caso seja exercido por
            qualquer
            das partes, serão aplicados os princípios que regem os contratos a prazo determinado, conforme disposto no
            art.
            481 da CLT, obrigando-se portanto, a parte que exercer o direito, a pré-avisar a outra, nas condições do
            art.
            481 e Esta tudo Consolidado.
        </p><br>
        <p class="f12 text-justify">
            E, por estarem de pleno acordo com as condições supra ajustadas, firmam o presente instrumento em 02 via(s)
            de
