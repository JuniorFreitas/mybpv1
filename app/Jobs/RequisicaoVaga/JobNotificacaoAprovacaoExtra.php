...
class JobNotificacaoAprovacaoExtra implements ShouldQueue
{
    ...
    public function __construct($requisicaoId, array $emailsExtra, $usuarioDeId, $etapa, $empresaId, $tipo = null, $status = null)
    {
