...
use App\Services\MudancaCargo\MudancaCargoExportFormatter;
use App\Services\MudancaCargo\MudancaCargoExportQueryBuilder;
...
class JobMudaCargoPrevistaExportaExcel implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $query = MudancaCargoExportQueryBuilder::forExport($user, $this->filtros);
            ...
            \Log::error('Erro na exportação Mudança de Cargo CSV: ' . $e->getMessage());
            throw $e;
        }
    }
