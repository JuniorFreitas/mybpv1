...
class DataHora
{
    ...
    private $dia_semana_carac = array("null", "segunda", "terca", "quarta", "quinta", "sexta", "sabado", "domingo");
    ...
    public function diaSemanaExtCarac()
    {

        return $this->dia_semana_carac[$this->diaSemanaNum()]; // dia da semana de 1 a 7
    }
