...
class EtapaProvaManualMail extends Mailable
{
...
//        $this->subject = "Parabéns! Você passou para a próxima etapa.";
        $this->subject = $this->dados['etapa'] == 'Aviso Recesso' ? "Aviso importante!" : "Parabéns! Você passou para a próxima etapa.";
    ...
    {
        return $this->view('email.recrutamento.EtapaProvaManual');
    }
}
