...
class AprovacaoMail extends Mailable
{
    ...
    public function __construct(array $dados)
    {
        ...
        $this->subject = "ATUALIZAÇÃO NA ADMISSÃO PREVISTA  - CARGO {$this->dados['cargo']}  CÓD - ". $this->dados['admissao_id'];
    ...
    {
        return $this->view('email.movimentacao.admissaoprevista.aprovar_reprovar');
    }
}
