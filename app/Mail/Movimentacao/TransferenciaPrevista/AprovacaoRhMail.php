...
class AprovacaoRhMail extends Mailable
{
    ...
    public function __construct(array $dados)
    {
        ...
        $this->subject = "CONFIRMAÇÃO RH PARA TRANSFERÊNCIA PREVISTA  - COLABORADOR {$this->dados['colaborador']}  CÓD - ". $this->dados['ferias_id'];
    ...
    {
        return $this->view('email.movimentacao.transferenciaprevista.aprovar_rh');
    }
}
