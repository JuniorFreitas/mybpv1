...
class CriadaMail extends Mailable
{
    ...
    public function __construct(array $dados)
    {
        ...
        $this->subject = "TRANSFERÊNCIA PREVISTA - COLABORADOR ".$this->dados['colaborador']." - CÓD: ".$this->dados['id'];
    ...
    {
        return $this->view('email.movimentacao.transferenciaprevista.criada');
    }
}
