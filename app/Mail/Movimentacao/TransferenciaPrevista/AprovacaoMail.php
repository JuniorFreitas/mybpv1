...
class AprovacaoMail extends Mailable
{
    ...
    public function __construct(array $dados)
    {
        ...
        $this->subject = "ATUALIZAÇÃO NA TRANSFERÊNCIA PREVISTA COLABORADOR ".$this->dados['colaborador']." - CÓD: ".$this->dados['id'];
    ...
    {
        return $this->view('email.movimentacao.transferenciaprevista.aprovar_reprovar');
    }
}
