...
class AprovacaoMail extends Mailable
{
    ...
    public function __construct(array $dados)
    {
        ...
        $this->subject = "ATUALIZAÇÃO NA MUDANÇA DE INTERMITENTE P/ FIXO - COLABORADOR ".$this->dados['colaborador']." - CÓD: ".$this->dados['id'];
    ...
    {
        return $this->view('email.movimentacao.mudaintermitentefixoprevista.aprovar_reprovar');
    }
}
