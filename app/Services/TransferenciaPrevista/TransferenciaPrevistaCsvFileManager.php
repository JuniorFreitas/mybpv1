...
class TransferenciaPrevistaCsvFileManager
{
    ...
    {
        $this->tempFilePath = tempnam(sys_get_temp_dir(), 'transferencia_prevista_export_') . '.csv';
    ...
    public function writeDataInChunks(Builder $query, TransferenciaPrevistaExportFormatter $formatter): int
    {
        $rowsWritten = 0;
