...
class IntermitenteFixoPrevistaCsvFileManager
{
    ...
    {
        $this->tempFilePath = tempnam(sys_get_temp_dir(), 'intermitente_fixo_prevista_export_') . '.csv';
    ...
    public function writeDataInChunks(Builder $query, IntermitenteFixoPrevistaExportFormatter $formatter): int
    {
        $rowsWritten = 0;
