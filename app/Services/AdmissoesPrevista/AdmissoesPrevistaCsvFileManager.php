...
class AdmissoesPrevistaCsvFileManager
{
    ...
    {
        $this->tempFilePath = tempnam(sys_get_temp_dir(), 'admissoes_prevista_export_') . '.csv';
    ...
    public function writeDataInChunks(Builder $query, AdmissoesPrevistaExportFormatter $formatter): int
    {
        $rowsWritten = 0;
