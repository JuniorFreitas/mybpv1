...
class ValorExtraPrevistaCsvFileManager
{
    ...
    {
        $this->tempFilePath = tempnam(sys_get_temp_dir(), 'valor_extra_prevista_export_') . '.csv';
    ...
    public function writeDataInChunks(Builder $query, ValorExtraPrevistaExportFormatter $formatter): int
    {
        $rowsWritten = 0;
